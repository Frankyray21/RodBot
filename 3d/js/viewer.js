  ...
  async create(opts = {}) {
    ...
    if (opts.ground === true) {
      ...
      const peindreSol = (imgSol) => {
        if (imgSol) {
          // harmonisation avec le plancher scanné (~124,120,108 mesuré) :
          // +6 % de luminosité et légère chaleur, aucun assombrissement
        ...
        // fondu radial vers le fond de page (#0a0e17), loin du plancher scanné
