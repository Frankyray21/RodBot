...
import { MODEL_URL, ENVIRONMENT_URL, POSTER_URL } from './model-assets.js?v=1.106.0';
import { attachPrecisionZoom } from './precision-zoom.js?v=1.106.0';
...
export const RodbotViewer = {
  async create(opts = {}) {
    ...
    let homeTarget = vector(opts.home?.target, [0, 1.25, 0]), loadingReject = null, precision = null;
