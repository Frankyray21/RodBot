...
const CACHE = 'rodbot-formation-v1.96.0';
...
const MODELE_3D = ['./3d/assets/rodbot-v7-photo.gltf', './3d/assets/rodbot-v6-c9499d45.glb', './3d/assets/warehouse-v5.hdr'];
...
const PRECACHE = [
  ...
  './3d/vendor/draco/draco_decoder.wasm', './3d/vendor/draco/draco_decoder.js', './3d/assets/rodbot-v7-photo-poster.jpg', './evaluation-risques.pdf',
