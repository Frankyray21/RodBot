...
const CORE = [
  ...
  './3d/js/hotspots-v6.js', './3d/js/hero-v6.js', './3d/js/model-assets.js', './3d/js/precision-zoom.js',
...
const MODELE_3D = ['./3d/assets/rodbot-v11-hydraulics.gltf', './3d/assets/rodbot-v11-hydraulics.bin', './3d/assets/rodbot-v10-mast-details.bin', './3d/assets/rodbot-v9-rear.bin', './3d/assets/rodbot-v6-c9499d45.glb', './3d/assets/warehouse-v5.hdr'];
...
const PRECACHE = [
  ...
  './3d/vendor/draco/draco_decoder.wasm', './3d/vendor/draco/draco_decoder.js', './3d/assets/rodbot-v11-hydraulics-poster.jpg', './evaluation-risques.pdf',
