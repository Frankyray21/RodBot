...
(function (root) {
  ...
  var before = null, view = '', modalType = '', modalReturns = {}, component = null;
  ...
  function beforeRender(app, c) {
    ...
    before = { inside: !!(active && app.contains(active)), key: active && active.getAttribute('data-rb-focus'), view: view };
  }
  function activeModal(app) {
    if (!app) return null;
    return Array.from(app.querySelectorAll('[data-rb-dialog]')).sort(function (a, b) { return Number(b.style.zIndex) - Number(a.style.zIndex); })[0] || null;
  }
