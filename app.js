...
var FIELD_GUIDES_FR = [
  [
    {title:"Comprendre le travail du RodBot", items:["Il déplace les tiges de forage.","Il prend son énergie sur la foreuse.","La télécommande garde l'opérateur à distance."]},
...
var FIELD_GUIDES_EN = [
  [
    {title:"Understand the RodBot's job", items:["It moves drill rods.","It gets power from the drill.","The remote keeps the operator at a distance."]},
