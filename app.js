...
var ENRICH = /*__ENRICH__*/{"0-0":{"blocks":[{"t":"p","text":"Le RodBot LP de Borterra est un système robotisé hydraulique de manutention de tiges de forage, pour charger et décharger les tiges en douceur. Il supprime la manutention manuelle des tiges — une des principales causes d'accidents liés aux foreuses — et s'adapte à de nombreux équipements : foreuses, plateaux à tiges et palettes."},{"t":"ul","items":["Transporteur de tiges sur chenilles ; les chenilles repositionnent le RodBot dans le puits.","Plateau à tiges amovible, pour tiges de 5 po de diamètre et jusqu'à 6 pi de long.","Alimentation hydraulique et électrique par câble relié à une foreuse.","Commande principale par radio-télécommande (RRC) : déplace les tiges sans intervention manuelle pendant le forage et la remontée."]},{"t":"warn","w":"note","text":"Le câble de liaison à la foreuse relie aussi les arrêts d'urgence (e-Stop) du RodBot et de la foreuse : les deux circuits d'arrêt d'urgence sont interconnectés."}],"figures":[]},"0-1":{"blocks":[{"t":"ul","items":["Commande directe (ou « commande manuelle par télécommande radio ») : les manettes activent chaque mouvement de joint rotatif individuellement, comme une machinerie lourde classique.","Commande linéaire : déplace la tige / le tubage en X, Y ou Z d'un seul mouvement de manette ; le système actionne plusieurs distributeurs hydrauliques en même temps. L'opérateur garde le contrôle individuel des actionneurs rotatifs de l'effecteur terminal (poignet, rotation, inclinaison du grappin).","Contrôle de trajectoire : le mât va automatiquement d'une posture initiale à une posture finale définie par l'utilisateur, sur une trajectoire calculée par le RodBot pour minimiser le temps de déplacement en évitant les collisions."]},{"t":"p","text":"En mode trajectoire, l'opérateur définit et enregistre d'abord des points de destination et de cheminement, en manipulant le mât par commande directe ou linéaire ; les tiges se déplacent ensuite entre deux emplacements d'un seul mouvement de manette. Détails aux sections 11.6.3 (linéaire) et 11.6.4 (trajectoire)."}],"figures":[]},"0-2":{"blocks":[{"t":"p","text":"L'illustration de la page 7 identifie les principaux composants de la machine."},{"t":"ul","items":["Grappin","Bac à tubes","Chenilles","Vérins de stabilisation","Boîtier de télécommande","Voyant lumineux","Panneau électrique 24 V","Piédestal","Mât","Compartiment de rangement"]}],"figures":[{"page":7,"cap":"Vue d'ensemble : composants principaux du RodBot LP (grappin, mât, piédestal, bac à tubes, chenilles, vérins de stabilisation, panneau électrique 24 V, voyant, boîtier de télécommande)."}]},"0-3":{"blocks":[{"t":"specs","rows":[["Poids à vide","5800 lb"],["Poids avec bac vide","6500 lb"],["Longueur","116 po"],["Largeur","60 po"],["Hauteur minimale","90 po"]]},{"t":"specs","rows":[["Charge max., levage à usage général","308 lb"],["Charge max., levage de tiges par électroaimant","120 lb"],["Diamètre des tiges","5 po"],["Longueur des tiges","6 pi"],["Capacité du bac","35 tiges"],["Portée verticale max. (tige verticale, depuis le sol)","159 po"],["Portée horizontale max. (depuis l'axe central)","119 po"]]}],"figures":[]},"0-4":{"blocks":[{"t":"specs","rows":[["Alimentation électrique","120 V c.a."],["Intensité maximale absorbée","4.5 A"],["Alimentation hydraulique","Depuis la pompe (non incluse) via l'ensemble de liaison (inclus)"],["Type de pompe requis","Cylindrée variable avec détection de charge"],["Plage de pression d'alimentation","2500-3000 psi"],["Débit maximal requis","80 L/min"],["Raccords hydrauliques","Pression (P), Réservoir (T), Drain de carter (T/Dr), Détection de charge (LS)"],["Longueur de l'ensemble de liaison","30 pi"]]},{"t":"specs","rows":[["Garde au sol","10 po"],["Transmission","Hydrostatique en circuit ouvert"],["Freins","À serrage par ressort, hydrostatiques"],["Pente max. de déplacement, bac vide","35° / 70 %"],["Pente max. de déplacement, bac plein","28° / 53 %"],["Pente max., manipulation des tiges","15° / 27 %"],["Longueur des chenilles","71 po"],["Écartement des chenilles","46 po"],["Largeur des chenilles","12 po"],["Vitesse max. de déplacement lent","2.8 km/h"],["Course des stabilisateurs","10.5 po"]]}],"figures":[]},"1-0":{"blocks":[{"t":"p","text":"Ce chapitre de sécurité couvre l'ajout de la télécommande radio et la mise en œuvre de la planification de trajectoire sur le manipulateur de tiges du mât."},{"t":"ul","items":["L'opérateur doit avoir lu et compris le manuel d'utilisation et respecter les calendriers d'entretien recommandés.","Le Rod Handler ne doit être utilisé, entretenu et réparé que par du personnel formé à l'équipement et conscient de ses dangers.","Le personnel doit respecter les réglementations de sécurité et de santé générales et locales."]},{"t":"warn","w":"note","text":"Le fabricant décline toute responsabilité pour les dommages dus à une utilisation inappropriée ou à des modifications arbitraires de l'équipement."}],"figures":[]},"1-1":{"blocks":[{"t":"specs","rows":[["DANGER","Situation mettant la vie en danger — doit impérativement être évitée."],["AVERTISSEMENT","Information d'une importance cruciale pour la sécurité."],["ATTENTION","Information visant à prévenir tout risque de blessure et/ou de dommage matériel."]]},{"t":"warn","w":"note","text":"Les procédures du manuel ne dispensent pas l'opérateur de rester prudent, ni de respecter la réglementation régionale et les règles de sécurité propres au site et à l'entreprise."}],"figures":[{"page":10,"cap":"Pictogrammes de sécurité du manuel : DANGER, AVERTISSEMENT et ATTENTION."}]},"1-2":{"blocks":[{"t":"ul","items":["N'utiliser le système robotisé qu'après une formation complète et une habilitation en règle.","Toujours lire et comprendre toutes les étiquettes avant utilisation.","N'utiliser l'équipement qu'en bonne condition physique et mentale, jamais sous l'influence d'alcool ou de drogues.","Ne jamais retirer les protections et capots de sécurité quand le système est sous tension et en marche.","Nettoyer les déversements et fuites d'huile avant la mise en service ; résoudre tout dysfonctionnement avant toute remise en service.","N'utiliser que des pièces de rechange identiques ou équivalentes aux pièces d'origine."]},{"t":"warn","w":"danger","text":"Fluides sous pression : une fuite d'huile hydraulique haute pression sur la peau peut provoquer une injection sous-cutanée. En cas de blessure, contacter immédiatement les urgences médicales ou un médecin habitué à ce type de blessure — risque de gangrène ou de réactions allergiques graves."},{"t":"warn","w":"warn","text":"En extérieur, ne pas utiliser le système par orage ou vents violents supérieurs à 65 km/h. Ne pas l'utiliser non plus si le système de commande signale une erreur ou si son bon fonctionnement est compromis."},{"t":"warn","w":"note","text":"N'entreprendre aucun entretien ni réparation sans autorisation, sans qualification appropriée et sans avoir lu et compris les consignes de sécurité du fabricant ; vérifier la réglementation locale et celle de la mine."}],"figures":[{"page":11,"cap":"Icônes des premières étapes — pratique sécuritaire de pleine conscience."}]},"1-3":{"blocks":[{"t":"p","text":"La machine a quatre emplacements d'arrêt d'urgence ; en activer un stoppe immédiatement tout mouvement de l'appareil de forage."},{"t":"specs","rows":[["Panneau de commande basse tension","Immédiatement sous l'IHM à écran tactile"],["Télécommande radio","Au centre, en bas"],["Châssis du RodBot","Coin inférieur avant droit du châssis"],["Commandes manuelles","À l'arrière, près des leviers hydrauliques de commande du mât"]]},{"t":"warn","w":"warn","text":"Si le signal d'arrêt d'urgence est couplé à l'appareil de forage principal, activer un arrêt d'urgence sur l'une des machines déclenche l'arrêt d'urgence sur les deux."}],"figures":[]},"2-0":{"blocks":[{"t":"p","text":"Le mât télescopique (bras robotisé) comprend plusieurs actionneurs de joint rotatif (poignet). Chaque joint a un numéro (J…) et un nom, indiqués sur le schéma page 13."},{"t":"ul","items":["TÉLESCOPE","PIVOTEMENT (SLEW)","ARTICULATION (ÉPAULE)","JOINT ROTATIF (POIGNET)","ROTATION","INCLINAISON","GRAPPIN (PINCE)"]},{"t":"warn","w":"note","text":"Exemple : la fonction PIVOTEMENT (SLEW) = J1 (« pivotement 1 »)."}],"figures":[{"page":13,"cap":"Schéma des segments du mât et noms des fonctions"}]},"2-1":{"blocks":[{"t":"p","text":"L'interrupteur de commande par l'opérateur, sur le panneau basse tension, détermine si le système robotisé accepte les ordres de la télécommande radio."},{"t":"specs","rows":[["Position CONTRÔLE À DISTANCE (REMOTE)","La télécommande radio est reliée au système robotisé et peut le piloter"],["Position LOCAL","Les ordres de la télécommande radio sont ignorés ; l'icône « No Radio » s'affiche"]]},{"t":"ul","items":["Commande par l'opérateur","Bouton de réinitialisation de sécurité","Panneau de commande principal HMI (Interface homme-machine)","PPU (Module de planification de trajectoire)","Récepteur radio","Arrêt d'urgence"]},{"t":"warn","w":"warn","text":"Pour piloter par radio, l'interrupteur DOIT être sur CONTRÔLE À DISTANCE (REMOTE). En LOCAL, aucun ordre radio n'est exécuté."}],"figures":[{"page":14,"cap":"Vue intérieure du panneau de commande principal"}]},"2-2":{"blocks":[{"t":"p","text":"Le bouton de réinitialisation de sécurité active (« met en place ») le circuit de sécurité du système robotisé."},{"t":"steps","items":["Au démarrage : appuyer pour établir (mettre en place) le circuit de sécurité.","Après un arrêt d'urgence déclenché puis réinitialisé : appuyer de nouveau pour réactiver le circuit."]}],"figures":[]},"2-3":{"blocks":[{"t":"p","text":"L'écran tactile du panneau principal (HMI/IHM, Interface Homme-Machine) affiche les informations du système de commande du RodBot. L'opérateur peut y modifier certains paramètres."},{"t":"ul","items":["Indicateur : interrupteur de commande par l'opérateur sur « LOCAL »","Icône « Émetteur-récepteur radio non activé (No Radio) »"]},{"t":"warn","w":"note","text":"Voir section 7 du manuel pour plus d'informations sur cet écran."}],"figures":[{"page":15,"cap":"Écran du panneau principal : indicateur mode LOCAL et icône No Radio"}]},"2-4":{"blocks":[{"t":"p","text":"Deux valves hydrauliques d'activation/isolation, normalement fermées, sont intégrées au collecteur de raccordement des flexibles de liaison. Leur état dépend du « MODE » choisi par l'opérateur, ou du système de sécurité en cas d'erreur."},{"t":"specs","rows":[["Nombre / type","2 valves, normalement fermées"],["Emplacement","Collecteur de raccordement des flexibles de liaison"],["Une valve","Régule le débit vers les chenilles et les vérins"],["L'autre valve","Régule le débit vers tous les autres éléments"],["Commande de l'état","Choix du MODE par l'opérateur ou système de sécurité (si erreur détectée)"]]},{"t":"warn","w":"warn","text":"En cas de coupure de courant, les deux valves se ferment par défaut, rendant toute opération hydraulique impossible."},{"t":"warn","w":"note","text":"Forçage manuel en position ouverte : tourner la valve dans le sens antihoraire."}],"figures":[{"page":16,"cap":"Soupape d'activation/d'isolation hydraulique du mât (normalement fermée ; se ferme en cas de coupure d'alimentation électrique)"}]},"3-0":{"blocks":[{"t":"p","text":"La télécommande radio (RRC), conçue pour le RodBot, résiste aux chocs, à la saleté, à l'humidité et à l'eau. Ses manettes sont entièrement proportionnelles et rappelées à zéro par ressort."},{"t":"specs","rows":[["Emplacement de la clé","Partie supérieure gauche de la télécommande"],["Rôle","La clé doit être présente pour que la télécommande fonctionne"],["Sans la clé","La télécommande ne s'allume pas"],["Retrait en cours de fonctionnement","Rupture de la liaison RRC ↔ récepteur et déclenchement d'un arrêt"]]},{"t":"warn","w":"warn","text":"Ne retirez jamais la clé physique pendant que la machine fonctionne : la liaison RRC ↔ récepteur est rompue et un arrêt est déclenché."}],"figures":[{"page":17,"cap":"Vue d'ensemble de la télécommande radio (RRC)"}]},"3-1":{"blocks":[{"t":"steps","items":["Mettre l'interrupteur OPERATOR CONTROL (panneau électrique) sur À DISTANCE (REMOTE) ; sinon aucun message de mouvement n'est reconnu.","Appuyer sur le bouton ON, côté gauche de la télécommande.","Vérifier que le voyant DEL, en bas à gauche de l'écran, passe au vert (état « ON »)."]},{"t":"p","text":"Pour désactiver la télécommande : appuyer sur son bouton d'arrêt d'urgence. Le réinitialiser ensuite en tournant la tête rouge en forme de champignon."},{"t":"warn","w":"warn","text":"Appuyer sur l'arrêt d'urgence de la télécommande arrête la foreuse, sauf si le sélecteur de mode a été préalablement réglé sur LOCAL."},{"t":"warn","w":"note","text":"La télécommande peut être allumée avec OPERATOR CONTROL sur LOCAL, mais le système ignore alors ses messages de mouvement du RodBot."}],"figures":[{"page":18,"cap":"Bouton MARCHE (ON) et bouton d'arrêt d'urgence de la télécommande"}]},"3-2":{"blocks":[{"t":"p","text":"L'arrêt d'urgence de la télécommande sans fil commande un relais sur le RodBot, monté en série avec les autres arrêts d'urgence du RodBot et de la foreuse mère (reliée électriquement)."},{"t":"p","text":"Télécommande activée et OPERATOR CONTROL sur REMOTE : appuyer sur l'arrêt d'urgence arrête le RodBot et la foreuse mère, comme n'importe quel arrêt d'urgence câblé du RodBot ou de la foreuse."},{"t":"warn","w":"danger","text":"En mode LOCAL, la communication radio est désactivée et le bouton d'arrêt d'urgence de la télécommande NE fonctionne PAS. Ne comptez jamais sur l'arrêt d'urgence de la RRC lorsque le sélecteur est sur LOCAL."},{"t":"warn","w":"note","text":"Désactiver la télécommande sans couper le moteur : mettre OPERATOR CONTROL sur LOCAL, puis désactiver via son bouton d'arrêt d'urgence. Utile pour remplacer une batterie faible ou économiser la batterie."}],"figures":[]},"3-3":{"blocks":[{"t":"p","text":"Les modes Rapide (Rabbit) / Lent (Turtle) appliquent un facteur d'échelle à toutes les articulations dans les modes DIRECT, LINÉAIRE et TRAJECTOIRE."},{"t":"specs","rows":[["Mode Rapide (Rabbit)","Vitesse maximale définie dans le menu Points de consigne des valves (section 8.5)"],["Mode Lent (Turtle)","Vitesse de chaque articulation limitée à 50 % (réduite de moitié)"],["Exception","Le grappin (pince) n'est pas ralenti par le mode Lent"]]}],"figures":[{"page":19,"cap":"Sélecteur Rapide (Rabbit)/Lent (Turtle) et contrôle de limite de la soupape hydraulique directionnelle"}]},"3-4":{"blocks":[{"t":"p","text":"La télécommande a un interrupteur d'inclinaison qui détecte une urgence opérateur (télécommande inclinée ou tombée)."},{"t":"ul","items":["Déclenchement : le RodBot passe en arrêt de sécurité, l'alimentation hydraulique est coupée.","Différence avec le bouton rouge : l'arrêt d'urgence câblé de la foreuse n'est PAS déclenché.","Récupération : télécommande remise à l'horizontale stable et aucun joystick actionné → sortie automatique de l'arrêt de sécurité et passage en veille."]},{"t":"warn","w":"note","text":"Inspection quotidienne : vérifier l'interrupteur d'inclinaison de la télécommande au début de chaque quart de travail."}],"figures":[]},"3-5":{"blocks":[{"t":"p","text":"Un voyant ambre sur le dessus du RodBot indique l'état du fonctionnement par télécommande radio."},{"t":"specs","rows":[["Allumé fixe","RodBot en mode CONTRÔLE PAR L'OPÉRATEUR – À DISTANCE"],["Éteint","RodBot en mode CONTRÔLE PAR L'OPÉRATEUR – LOCAL"],["Clignotant","Mât en mode TRAJECTOIRE, ou machine se déplaçant en mode RALENTI"]]}],"figures":[]},"3-6":{"blocks":[{"t":"p","text":"La section 6.7 décrit les commandes des manettes pour chaque mode du LP RodBot. La télécommande a trois manettes proportionnelles : JS1, JS2 et JS3."},{"t":"ul","items":["JS1 : contrôle de l'aimant (une fonction est libre, sans affectation)","Commande de l'avertisseur sonore (klaxon) et du gyrophare","Activation du grappin (pince)","Sélecteur Rapide (Rabbit) / Lent (Turtle)","Voyant d'état ; témoins d'état et de batterie faible","Boutons de sélection de modes : Veille (attente), Direct et Linéaire","Boutons de sélection de modes : MARCHE, stabilisateurs et balayage","Activation de la trajectoire ; Aide, Attendre, Commencer","Réglage de la luminosité de l'écran ; feux de travail (Work Lights)","Arrêt d'urgence"]},{"t":"warn","w":"note","text":"En mode Lent, la vitesse des actionneurs est réduite de moitié (50 %), sauf pour le grappin (pince)."}],"figures":[{"page":21,"cap":"Disposition des manettes JS1/JS2/JS3, boutons et interrupteurs de la télécommande"},{"page":22,"cap":"Détail des commandes de la télécommande radio"}]},"3-7":{"blocks":[{"t":"p","text":"L'IHM de la télécommande n'est PAS un écran tactile : les touches du clavier au-dessus de l'écran correspondent aux icônes affichées. L'affichage change selon l'état du RodBot pour fournir les renseignements et options de commande pertinents."},{"t":"ul","items":["Position de la foreuse et points de trajectoire (du râtelier à la foreuse)","Indicateur d'ÉTAT du système","Indicateur de l'état de charge de la batterie","Positions du râtelier (Rack Positions)","Type de mode de fonctionnement et indicateur de mode","État du grappin et état de l'aimant","Mode Lent / Rapide","L'encadré jaune indique l'élément sélectionné"]}],"figures":[{"page":23,"cap":"Écran (IHM) de la télécommande : correspondance touche / icône"},{"page":24,"cap":"Écran typique avec libellés des indicateurs d'état"}]},"3-8":{"blocks":[{"t":"p","text":"Le niveau de charge de la batterie s'affiche en haut à droite de l'écran de la télécommande, ainsi qu'en bas de l'écran du panneau électrique."},{"t":"warn","w":"warn","text":"Si la télécommande perd le contact radio ou s'éteint pendant le fonctionnement (batterie à plat), la machine assimile cette situation à un arrêt d'urgence. Suivez la procédure ci-dessous pour changer la batterie sans déclencher l'arrêt."},{"t":"steps","items":["Placer le sélecteur COMMANDE PAR L'OPÉRATEUR sur LOCAL.","Mettre la télécommande sur FERMER (OFF), en appuyant sur l'arrêt d'urgence de la télécommande ou sur la RRC.","Remplacer la batterie.","Mettre la télécommande sur MARCHE (ON).","Vérifier que l'icône de liaison radio, au bas du moniteur de contrôle, est rétablie.","Remettre le sélecteur COMMANDE PAR L'OPÉRATEUR en position À DISTANCE."]},{"t":"p","text":"Chargement et rangement : le coffret de rangement sur la machine contient un chargeur. Insérer la batterie dans le chargeur ; la charge démarre automatiquement."}],"figures":[{"page":44,"cap":"Chargeur et boîte de rangement de la télécommande radio"}]},"4-0":{"blocks":[{"t":"p","text":"Navigation par les icônes de la barre latérale gauche : appuyer ouvre la page, appuyer de nouveau revient au menu principal. La barre supérieure affiche : état de la connexion radio, puissance du signal, mode actif, état du contrôleur, versions logicielles PLC et PPU (module de planification de trajectoire)."},{"t":"specs","rows":[["Connexion radio – vert","Télécommande allumée et connectée"],["Connexion radio – rouge","Télécommande non opérationnelle ou non autorisée"],["Indicateur contrôleur – vert","Systèmes opérationnels"],["Indicateur contrôleur – rouge","Système hors tension ou en ERREUR"],["Indicateur contrôleur – jaune","Chargement en cours ou avertissement (non-erreur)"]]},{"t":"ul","items":["Appuyer sur un cercle d'état en surbrillance affiche le détail du sous-système.","Bouton « Paramètres système » : ouvre deux écrans (flèches en haut à droite) — Facteur de courbe des manettes (section 8.4) et Consigne de la valve de limitation (section 8.5)."]},{"t":"warn","w":"note","text":"Étalonnage du codeur, réglage des articulations (étalonnage PPU) et écran de dérogation des valves : modifiables seulement après connexion administrateur. Identifiants IHM — utilisateur : opt / mot de passe : qwer."}],"figures":[{"page":25,"cap":"Écran d'accueil de l'IHM : barre supérieure d'état et boutons de navigation"}]},"4-1":{"blocks":[{"t":"p","text":"Le bouton « ALARMES » ouvre un tableau pour diagnostiquer les anomalies du RodBot et repérer les risques de sécurité. Causes de défauts : défauts du réseau CAN au démarrage, articulations actionnées manuellement en mode télécommande, etc."},{"t":"ul","items":["Informations système","Avertissements système","Défauts système"]},{"t":"steps","items":["Consulter la colonne ÉTAT : un défaut résolu s'affiche Inactif.","Appuyer sur la ligne du défaut à effacer.","Appuyer sur « Effacer le défaut ».","Naviguer entre les pages avec les flèches en haut à droite."]},{"t":"warn","w":"warn","text":"Effacer TOUS les défauts, actifs ET inactifs, avant de reprendre le fonctionnement."}],"figures":[{"page":27,"cap":"Exemple de l'écran ALARMES avec la colonne ÉTAT"}]},"4-2":{"blocks":[{"t":"p","text":"La vue TRAJECTOIRE est un modèle 3D en temps réel du mât et des obstacles, selon le logiciel de planification de trajectoire. Accès par le bouton en bas à gauche de l'IHM ; appuyer sur une des quatre vues l'agrandit, un nouvel appui revient en arrière."},{"t":"ul","items":["Diagnostiquer les problèmes après une collision","Confirmer les lectures des codeurs","Diagnostiquer les problèmes de points de consigne"]},{"t":"p","text":"Objets perçus et évités lors de la planification : limite supérieure, limite inférieure, mât de forage, RodBot et son bac à tiges."},{"t":"warn","w":"warn","text":"Le logiciel ne peut pas modéliser tous les objets d'une mine souterraine. Si un objet à éviter n'apparaît pas à l'écran, ajouter des points de consigne pour le contourner."}],"figures":[{"page":28,"cap":"Vue TRAJECTOIRE : modèle 3D à quatre vues de la position du mât"},{"page":29,"cap":"Objets perçus et évités : limites supérieure/inférieure, mât et bac à tiges"}]},"4-3":{"blocks":[{"t":"p","text":"L'étalonnage du codeur est requis si un codeur est remplacé, ou s'il s'est desserré et a glissé sur l'arbre. Amener l'articulation en position d'origine puis réinitialiser le « point zéro » ; sans cette réinitialisation, le codeur ne transmet pas l'orientation exacte de l'articulation."},{"t":"steps","items":["Allumer la machine et régler la télécommande en mode DIRECT.","Se connecter à l'IHM avec les identifiants administrateur (opt / qwer).","Une articulation à la fois : la déplacer à sa position de zéro indiquée, puis appuyer sur le bouton correspondant de l'IHM.","Vérifier que la valeur change au déplacement, passe à zéro après appui, et à chaque retour à cette butée."]},{"t":"specs","rows":[["J1 – Pivotement","Butée mécanique antihoraire"],["J2 – Articulation (épaule)","Position haute maximale"],["J3 – Télescope","Entièrement rentré"],["J4 – Joint rotatif (poignet)","Position basse maximale"],["J5 – Rotation","Sens antihoraire jusqu'à la butée mécanique"],["J6 – Inclinaison","Vérin d'inclinaison entièrement déployé jusqu'à la butée mécanique"]]},{"t":"warn","w":"note","text":"Codeurs très précis : de légers écarts sont acceptables (la valeur peut afficher 1° ou 359° au lieu de 0°)."}],"figures":[{"page":31,"cap":"Positions de point zéro des articulations J1 à J6"}]},"4-4":{"blocks":[{"t":"specs","rows":[["Butées mécaniques","+/- 165° (course totale 330°)"],["Zone morte","30° directement à l'avant du système robotisé"],["Limites logicielles par défaut","10° et 320° (correspondent aux butées mécaniques)"]]},{"t":"p","text":"Les limites logicielles affichées sur l'écran d'étalonnage peuvent restreindre davantage la rotation de pivotement. Pour les modifier, appuyer sur le nombre à l'écran et saisir la valeur voulue."},{"t":"warn","w":"note","text":"Le bouton NEUTRALISER LES LIMITES D'ARTICULATION (OVERRIDE JOINT LIMITS) autorise la course complète jusqu'aux butées ; il se réinitialise dès que l'opérateur quitte l'écran d'étalonnage."}],"figures":[{"page":32,"cap":"Limites de rotation du pivotement et zone morte avant"}]},"4-5":{"blocks":[{"t":"p","text":"L'écran de contournement des valves s'affiche lors d'un défaut de valve dans l'un des deux blocs. Réservé à un opérateur expérimenté. Pour basculer un contournement, appuyer sur la case « Contournement de défaut » à côté de l'articulation en défaut."},{"t":"ul","items":["Un défaut connu et non critique est survenu (p. ex. surchauffe) et l'opérateur doit absolument continuer à faire fonctionner la machine.","Un défaut de valve est présent sur le bloc Mode Ralenti et Stabilisateurs et l'opérateur veut continuer en mode Bras — ou inversement."]},{"t":"warn","w":"danger","text":"Un bouton de contournement actionné fait ignorer TOUS les défauts de cette valve. Dangereux si le défaut est critique ou s'il servait à éviter un danger imminent pour le personnel ou la machine."}],"figures":[{"page":33,"cap":"Écran de contournement des défauts de valve"}]},"4-6":{"blocks":[{"t":"p","text":"Les courbes des manettes règlent la sensibilité des actionneurs hydrauliques par rapport aux commandes : soit plus de course de manette pour un contrôle précis, soit une augmentation linéaire de la vitesse d'articulation. Pour changer de courbe, sélectionner la sensibilité sur l'IHM ; l'icône s'allume pour confirmer."},{"t":"p","text":"Si les articulations se déplacent trop vite en mode DIRECT, l'écran LIMITES DES CONSIGNES DE VALVE plafonne la vitesse maximale de chaque articulation : manette poussée à fond, le débit de valve est plus faible, donc la vitesse d'actionneur est réduite. Appuyer sur la valeur de l'articulation, saisir le nouveau pourcentage, valider par Entrée."},{"t":"specs","rows":[["Courbes de commande disponibles","0 à 3"],["Consigne de valve – maximum","100 % (ne peut être dépassé)"],["Consigne de valve – minimum conseillé","10 %"]]},{"t":"warn","w":"note","text":"La restriction s'applique aux deux sens de l'articulation, mais la vitesse réelle peut varier selon la gravité. Pour des vitesses > 100 % ou < 10 %, consulter MEDATech pour un tiroir de valve différent. Un bouton rétablit les réglages d'usine."}],"figures":[{"page":34,"cap":"Courbes de commande de la manette disponibles (0 à 3)"},{"page":35,"cap":"Écran des limites de consigne de valve par articulation"}]},"4-7":{"blocks":[{"t":"p","text":"Le réglage des articulations s'impose si le mouvement du mât devient saccadé ou difficile à contrôler en modes LINÉAIRE et Trajectoire, une fois l'étalonnage des codeurs fait. Deux types : Seuil (consigne de valve la plus basse pour amorcer le mouvement) et Dynamique (délais et vitesses correspondant à une plage de consignes de valve)."},{"t":"steps","items":["Amener chaque articulation à moins de 2° ou 5 mm de sa cible, en mode DIRECT.","Appuyer sur le bouton jaune de l'IHM : il passe au vert et l'écran d'étalonnage apparaît sur la télécommande radio (RRC).","Sur la RRC, choisir l'articulation avec le sélecteur, sous le type voulu (Seuil ou Dynamique).","Maintenir la manette gauche vers la gauche : l'écran affiche « CALIBRATING » et l'articulation fait deux cycles de va-et-vient (relâcher avant la fin annule).","Une fois terminé, le point jaune passe au vert ; répéter pour chaque articulation requise.","Insérer la clé USB rouge MEDATech dans le câble bleu du PPU, attendre 1 minute, puis la retirer.","Envoyer le fichier « medatech_calibration » à MEDATech, qui renvoie un fichier « cal.7z ».","Placer « cal.7z » sur la clé USB rouge, la réinsérer 1 minute, puis appuyer sur le bouton vert de l'IHM pour redémarrer le PPU."]},{"t":"specs","rows":[["Pivotement","25° dans le sens horaire en premier"],["Articulation (épaule)","50° vers le bas en premier"],["Télescopage","140 mm vers l'extérieur en premier"],["Joint rotatif (poignet)","30° vers le haut en premier"],["Rotation","20° dans le sens horaire (manette) en premier"],["Inclinaison","40° vers la droite en premier"]]},{"t":"warn","w":"warn","text":"Pendant l'étalonnage, les articulations se déplacent sans commande directe de l'opérateur et sans détecter leur environnement. Rester vigilant pour éviter toute collision avec le RodBot ou un obstacle. Relâcher la manette arrête le mât à tout instant ; prévoir un espace suffisant, sinon déplacer la machine ou contacter MEDATech."}],"figures":[{"page":36,"cap":"Pose de réglage : position actuelle amenée à la position cible du mât"},{"page":39,"cap":"Écran d'étalonnage de la RRC : sélection actuelle et indicateur d'état"}]},"4-8":{"blocks":[{"t":"p","text":"Les diagnostics indiquent l'état de divers éléments du système de commande (communications des composants ou du réseau). Le bouton Diagnostics de l'écran d'accueil (HOME) ouvre le premier de trois écrans ; ces écrans sont informatifs et non interactifs, sauf les flèches de navigation en haut à droite."},{"t":"ul","items":["Diagnostic des Codeurs","Diagnostic des Valves","Diagnostic du Système Électrique"]},{"t":"warn","w":"note","text":"Interverrouillage : les valves perdent la communication hors de leur mode désigné (RALENTI ou MÂT). Les valves du mode RALENTI apparaissent en défaut en mode MÂT, et inversement — c'est normal. Ne s'inquiéter que si une valve est en défaut alors qu'elle est dans son mode désigné (p. ex. valve de PIVOTEMENT en défaut en mode MÂT)."}],"figures":[{"page":41,"cap":"Premier écran de diagnostic accessible depuis HOME"}]},"5-0":{"blocks":[{"t":"p","text":"Le RodBot n'a aucune alimentation embarquée : il puise son énergie électrique et hydraulique dans des sources externes fournies par l'opérateur, généralement montées sur la foreuse desservie. Des ensembles de câbles de liaison de 10 m les relient, ce qui lui permet de se positionner librement par rapport à la foreuse."},{"t":"specs","rows":[["Câble 24 V CC (électronique embarquée)","réf. 279708"],["Câble d'arrêt d'urgence (liaison au circuit de la foreuse mère)","réf. 279729"],["Conditionnement des deux câbles","un seul ensemble sous gaine spirale"],["Raccordement au panneau de commande du RodBot","connecteurs 2 et 4"]]},{"t":"ul","items":["Le boîtier de raccordement se monte sur la foreuse mère : il contient un bloc d'alimentation 120 V CA → 24 V CC et un point de connexion pour le câble d'arrêt d'urgence.","Pour garder les circuits d'arrêt d'urgence du RodBot et de la foreuse mère indépendants, installer des cavaliers entre 8-1 et 7-2 selon le schéma électrique.","Si la foreuse mère fournit un 24 V suffisant (section 1.1.3), le bloc d'alimentation 24 V CC peut être omis et la source raccordée directement à CONN1."]},{"t":"warn","w":"danger","text":"Installer le LP RodBot de sorte qu'une barrière sépare l'opérateur de la machine et de la foreuse ; le pilotage se fait par télécommande radio de part et d'autre de cette barrière. Si le mât télescopique (bras robotisé) bouge de façon inattendue sans commande, appuyer immédiatement sur l'arrêt d'urgence puis diagnostiquer."}],"figures":[{"page":45,"cap":"Montage du boîtier de raccordement et câbles de liaison 24 V CC / arrêt d'urgence"},{"page":46,"cap":"Schéma électrique du boîtier ; raccordement aux connecteurs 2 et 4 du panneau du RodBot"}]},"5-1":{"blocks":[{"t":"p","text":"Les fonctions hydrauliques du RodBot sont entraînées par une pompe fournie par l'opérateur, généralement une pompe auxiliaire montée sur la foreuse mère. Exigences de cette pompe source : section 1.1.3."},{"t":"ul","items":["Ligne de pression","Ligne de réservoir","Ligne de détection de charge (Load Sense)","Ligne de drainage du carter"]},{"t":"specs","rows":[["Ensemble de flexibles de liaison hydraulique","réf. 278232, flexibles de 10 m"],["Cloison de raccordement à raccords rapides","réf. 278240"],["Montage de la cloison","2 boulons de 3/8 po"],["Raccordement au RodBot","au bloc de distribution"]]},{"t":"warn","w":"warn","text":"Le remplacement de la pompe peut exiger un nouveau calibrage. Les modes TRAJECTOIRE et LINÉAIRE reposent sur des valeurs réglées de latence, de vitesse de rampe et de pression maximale de l'alimentation hydraulique. Si l'un de ces modes (ou les deux) donne de mauvaises performances après un changement de pompe, contacter MEDATech Engineering pour planifier un nouveau calibrage."}],"figures":[{"page":47,"cap":"Ensemble de flexibles de liaison : pression, réservoir, détection de charge, drainage du carter"},{"page":48,"cap":"Cloison de raccordement (2 boulons 3/8 po) et bloc de distribution du RodBot"}]},"5-2":{"blocks":[{"t":"steps","items":["Raccorder le RodBot à l'alimentation par le câble de liaison relié au coffret d'alimentation de la foreuse principale.","Attendre que l'écran de l'IHM s'allume (environ 30 secondes).","Vérifier que l'arrêt d'urgence de la télécommande est déverrouillé, puis appuyer sur le bouton vert de démarrage pour mettre sous tension.","Suivre les instructions à l'écran de la télécommande pour l'associer en appuyant de nouveau sur le bouton vert de démarrage.","Suivre les instructions de la télécommande et de l'IHM pour appuyer sur le bouton de réarmement de sécurité du panneau de contrôle.","Attendre la fin de la séquence de démarrage ; l'IHM affiche l'état avant de passer en mode VEILLE.","En mode VEILLE, le système est prêt : sélectionner les modes depuis la télécommande avec les boutons latéraux."]},{"t":"warn","w":"note","text":"L'écran de l'IHM met environ 30 secondes à s'allumer. La séquence se termine toujours en mode VEILLE, l'état prêt à l'emploi."}],"figures":[{"page":49,"cap":"Écran de l'IHM et séquence normale de mise en marche du RodBot"}]},"5-3":{"blocks":[{"t":"p","text":"Le mode se sélectionne depuis la télécommande radio, selon le schéma de la section 6.7. Chaque mode restreint les fonctions accessibles — une protection : seules les commandes du mode actif sont traitées."},{"t":"specs","rows":[["VEILLE (ou DÉMARRAGE)","mode de sécurité : aucune commande possible"],["RALENTI","commande des transmissions à chenilles uniquement"],["STABILISATEURS","commande des quatre vérins (stabilisateurs) uniquement"],["DIRECT","mode de commande du mât télescopique (bras robotisé)"],["LINÉAIRE","second mode de commande du mât télescopique"],["TRAJECTOIRE","déplacement autonome du bras selon des points de consigne prédéfinis"]]}],"figures":[{"page":50,"cap":"Sélection du mode de fonctionnement depuis la télécommande radio"}]},"5-4":{"blocks":[{"t":"p","text":"Toutes les fonctions peuvent être actionnées « manuellement » en déplaçant les leviers des distributeurs hydrauliques lorsque le sélecteur COMMANDE PAR L'OPÉRATEUR est en position LOCAL."},{"t":"warn","w":"warn","text":"Déplacer les leviers manuellement en mode TÉLÉCOMMANDE : le système de sécurité détecte une erreur de valve et passe en arrêt de protection, coupant l'alimentation hydraulique."},{"t":"steps","items":["Passer la machine en mode LOCAL avec le commutateur du panneau de commande basse tension.","Appuyer sur le bouton de réarmement de sécurité pour annuler l'arrêt de protection."]},{"t":"ul","items":["Mise en marche possible si COMMANDE PAR L'OPÉRATEUR est sur LOCAL ; ou","si COMMANDE PAR L'OPÉRATEUR est sur À DISTANCE et que la télécommande radio est activée, arrêt d'urgence non enfoncé.","« REMISE DE SÉCURITÉ À ZÉRO » rétablit le circuit de sécurité et la communication radio."]}],"figures":[{"page":51,"cap":"Bloc de distributeurs « Chenilles et Vérins » et leviers manuels (entretien uniquement)"}]},"5-5":{"blocks":[{"t":"p","text":"Pour commander les chenilles depuis la télécommande, la régler sur le mode RALENTI. Le passage en RALENTI est impossible quand les mâchoires du grappin sont fermées. Les leviers manuels du bloc « Chenilles et Vérins » servent uniquement à l'entretien des chenilles (section 13.6) : le RodBot est livré avec ces leviers déconnectés et rangés dans le compartiment arrière."},{"t":"ul","items":["Pivotement : orienté parallèlement au châssis de la machine","Levage : abaissé au maximum","Télescope : rétracté","Poignet : orienté vers le bas","Grappin : ouvert"]},{"t":"specs","rows":[["Vitesse maximale — rapide (Hi)","2,8 km/h"],["Vitesse maximale — lente (Lo)","1,5 km/h"],["Valve de dérivation manuelle","tête carrée de 0,55 po, à tourner de 90°"],["Passage en vitesse rapide (Hi)","rotation dans le sens des aiguilles d'une montre"],["Passage en vitesse lente (Lo)","rotation dans le sens inverse des aiguilles d'une montre"]]},{"t":"warn","w":"danger","text":"Ne jamais déplacer le RodBot avec les valves manuelles : risque d'être heurté ou écrasé par le véhicule. Toujours déplacer la machine par télécommande radio. Avant tout déplacement : inspecter visuellement la trajectoire (personnel, obstacles, cavités, terrains instables), ne jamais se tenir devant ou à côté de la machine, faire appel à un signaleur si la visibilité est obstruée, et garder les câbles de liaison hydrauliques et électriques hors de la trajectoire et du train de roulement — ne pas rouler dessus."}],"figures":[{"page":52,"cap":"Pose de transport du bras à adopter avant tout déplacement"},{"page":53,"cap":"Valve de dérivation manuelle Hi/Lo (carré de 0,55 po) du circuit des chenilles"}]},"5-6":{"blocks":[{"t":"p","text":"Le mode VEILLE permet de coupler la télécommande radio au récepteur, mais aucune commande de la télécommande n'est traitée par le système. Il offre un mode sécurisé pour démarrer la télécommande radio avant de passer aux modes de travail."},{"t":"warn","w":"note","text":"En mode VEILLE, toutes les fonctions de sécurité (arrêt d'urgence et interrupteur d'inclinaison) ainsi que les feux restent fonctionnels."}],"figures":[{"page":54,"cap":"Amplitude de mouvement du mât : système de positionnement à 6 degrés de mobilité"}]},"6-0":{"blocks":[{"t":"steps","items":["Fermer le grappin sur la tige : maintenir le bouton vert GRAPPIN et basculer le commutateur GRAPPIN vers le bas, en même temps.","Ouvrir le grappin et libérer la tige : maintenir le bouton vert GRAPPIN et le levier GRAPPIN vers le haut au moins 1 seconde."]},{"t":"p","text":"Le bouton vert GRAPPIN est une sécurité : le maintenir enfoncé pendant toute la manœuvre, sinon la commande est ignorée."},{"t":"warn","w":"danger","text":"Ne jamais se placer sous le mât ou le grappin. Attention aux éléments suspendus des mines souterraines (câbles électriques, conduites d'eau et d'air, tuyaux de ventilation) : tout contact du mât télescopique peut entraîner des blessures graves, la mort ou des dommages matériels."}],"figures":[{"page":55,"cap":"Commande du grappin : bouton vert et bascule actionnés simultanément"},{"page":56,"cap":"Façade de la télécommande : bouton vert GRAPPIN et bascule du grappin"}]},"6-1":{"blocks":[{"t":"p","text":"DIRECT ou LINÉAIRE : au choix. Le mode LINÉAIRE est le plus simple pour la plupart des opérateurs. En DIRECT, on commande chaque articulation (comme une grue, un ou plusieurs actionneurs). En LINÉAIRE, on commande directement la position du grappin et de la tige."},{"t":"specs","rows":[["Mode DIRECT","Commande articulation par articulation ; inscriptions BLANCHES sur la façade"],["Mode LINÉAIRE","Commande de l'effecteur en ligne droite ; étiquette ORANGE"],["Manette gauche (LINÉAIRE)","Haut/Bas et Gauche/Droite"],["Manette droite (LINÉAIRE)","Intérieur/Extérieur (Int./Ext.)"],["Amplitude du mât","6 degrés de mobilité ; pivotement 330° entre butées fixes (butée souple programmable)"]]},{"t":"ul","items":["AVANT / ARRIÈRE — le mât rapproche ou éloigne la tige de la base en ligne droite, plan horizontal.","HAUT / BAS — le mât monte ou descend la tige en ligne droite, même plan.","GAUCHE / DROITE — pivote le mât sur son socle (PIVOTEMENT), comme en commande manuelle."]},{"t":"warn","w":"note","text":"En mode LINÉAIRE, le système gère tous les mouvements. Le joint rotatif (poignet), la rotation et l'inclinaison restent commandables séparément pour affiner le positionnement de l'effecteur terminal."}],"figures":[{"page":57,"cap":"Contrôle LINÉAIRE (étiquette orange) et affectation des manettes gauche/droite"},{"page":54,"cap":"Amplitude de mouvement du mât à 6 degrés de mobilité"}]},"6-2":{"blocks":[{"t":"p","text":"Le mode TRAJECTOIRE déplace le mât par des points de consigne prédéfinis, en évitant les obstacles (navigation autonome). Accessible après avoir activé LINÉAIRE ou DIRECT. Points minimaux requis : FOREUSE, ATTENTE, LIMITE SUPÉRIEURE et LIMITE INFÉRIEURE."},{"t":"steps","items":["Ouvrir l'écran de configuration : maintenir le bouton LINÉAIRE (ou DIRECT) 3 secondes.","Saisir une tige de forage par son centre (± 2\" / 5 cm).","Positionner la tige dans le mât de forage ou le présentateur.","Avec le sélecteur de point de trajectoire, mettre FOREUSE en surbrillance (vert = point actif).","Pousser le commutateur « Enregistrer/Sélection » vers le haut : un crochet apparaît dans la case de l'icône à l'écran."]},{"t":"specs","rows":[["POINT DU PLATEAU 1","Par défaut au-dessus et au centre du bac à tiges ; modifiable"],["POINT DU PLATEAU 2","2e plateau (au sol/à l'écart), tiges plus longues ; ≥ 1' (30 cm) au-dessus du plateau, parallèle au stockage"],["ATTENTE","Point hors du mât ; dernier segment = trajectoire directe vers le train de tiges ; souvent 1 à 2 pieds de FOREUSE"],["FOREUSE","Point de libération et de transfert de la tige à la foreuse ; obligatoire"],["POINT 1 / POINT 2","Points de passage optionnels pour contourner un obstacle"]]},{"t":"p","text":"Exemple d'ordre : POINT DU PLATEAU → POINT 2 → POINT 1 → ATTENTE → FOREUSE. Pour supprimer un point, le mettre en surbrillance et pousser « Enregistrer/Sélection » vers le bas."}],"figures":[{"page":59,"cap":"Sélecteurs de point de trajectoire et vue latérale d'un exemple de mode automatique"},{"page":61,"cap":"Vue de dessus : ajout d'un point de passage pour contourner une obstruction"}]},"6-3":{"blocks":[{"t":"p","text":"Les Limites Supérieure et Inférieure sont deux plans horizontaux définis par l'opérateur qui empêchent le mât et la tige d'entrer dans certaines zones. Le logiciel les utilise pour éviter les collisions avec les conduites, le toit / la voûte, une traverse ou le sol. Obligatoires pour le mode TRAJECTOIRE."},{"t":"ul","items":["Le RodBot lui-même","La foreuse","Le bac à tiges sur le RodBot","L'arrière (Back)","Le plancher (Floor)"]},{"t":"steps","items":["Vider le grappin avant de le descendre (recommandé).","Placer le grappin à la hauteur sous laquelle la tige et le RodBot ne doivent pas descendre — le plan est fixé par le centre de gravité du grappin.","En général à 30 cm du sol, pousser l'interrupteur vers le haut pour définir le plan inférieur.","Suivre une procédure similaire pour définir la Limite Supérieure."]},{"t":"warn","w":"note","text":"Tige détectée dans le grappin en mode TRAJECTOIRE : le planificateur suppose une tige de 1,8 m (6') tenue à moins de 5 cm (2\") de son centre et génère un tracé où aucune partie du tuyau ne franchit un plan. Le point FOREUSE fixe la position du mât de la foreuse : le redéfinir à chaque nouvelle configuration."}],"figures":[{"page":62,"cap":"Zones d'exclusion préréglées et plans Limites supérieure/inférieure autour du mât"},{"page":63,"cap":"Centre de gravité du grappin et sélecteurs des plans limites supérieur/inférieur"}]},"6-4":{"blocks":[{"t":"warn","w":"danger","text":"Le RodBot n'a AUCUN système de vision : il ne détecte ni travailleurs, ni véhicules, ni équipements entrant dans sa zone de travail. Limiter la circulation du personnel dans l'enveloppe de travail du mât ; installer barrières, délimitations et restrictions d'exploitation selon les politiques et procédures de la mine."},{"t":"warn","w":"warn","text":"Mouvement inattendu en mode automatique : appuyer immédiatement sur un bouton d'arrêt d'urgence (télécommande ou système robotisé)."},{"t":"warn","w":"note","text":"Sécurité : en MODE RALENTI, si la machine se déplace, tous les points de consigne sont supprimés SAUF le POINT DU PLATEAU 1 ; reconfigurer tous les autres depuis le nouvel emplacement."},{"t":"warn","w":"note","text":"Les réglages TRAJECTOIRE (points et limites) sont conservés même après mise hors tension et redémarrage. Supprimer les points ainsi que les limites supérieure et inférieure à la fin de chaque tâche, avant la configuration suivante."}],"figures":[{"page":62,"cap":"Enveloppe de travail du mât — aucune détection de présence dans la zone"}]},"6-5":{"blocks":[{"t":"steps","items":["Vérifier que tous les points de trajectoire requis et les limites supérieure et inférieure sont définis.","Avec le sélecteur de points de trajectoire, choisir la destination : FOREUSE ou ATTENTE, et POINT DU PLATEAU 1 ou 2.","Maintenir le bouton jaune TRAJECTOIRE et déplacer le levier droit : DROITE = PLATEAU (RACK), GAUCHE = FOREUSE (DRILL).","Mouvement amorcé, relâcher le bouton jaune : le mât poursuit la trajectoire tant que le levier reste actionné.","Relâcher les manettes arrête immédiatement le mouvement du mât."]},{"t":"p","text":"En relâchant le bouton jaune, la télécommande revient au mode LINÉAIRE ou DIRECT précédent. On peut reprendre la commande manuelle à tout moment, puis réactiver TRAJECTOIRE (bouton jaune + levier droit) : une nouvelle trajectoire sans collision est générée vers la destination. Le mode ne fonctionne que si une trajectoire sans collision est possible."},{"t":"warn","w":"note","text":"Directions du levier droit : DROITE = PLATEAU (RACK), GAUCHE = FOREUSE (DRILL)."}],"figures":[{"page":64,"cap":"Bouton jaune TRAJECTOIRE et levier droit pour lancer le déplacement autonome"},{"page":65,"cap":"Mode linéaire sélectionné : déplacement de la tige vers la FOREUSE ou le PLATEAU"}]},"6-6":{"blocks":[{"t":"p","text":"Le châssis comporte des éléments d'alignement pour bien positionner le bac à tiges. Le bac n'est pas boulonné ni bridé : il est maintenu uniquement par les dispositifs de retenue du châssis."},{"t":"steps","items":["Engager les fourreaux pour fourches du bac dans les profilés du châssis.","Positionner le bac latéralement entre les deux pattes de retenue du châssis.","Vérifier que le bac est bien retenu avant toute manutention."]},{"t":"warn","w":"note","text":"Le bac repose sur des retenues, non boulonné : contrôler son engagement et son alignement avant de charger des tiges ou de déplacer la machine."}],"figures":[{"page":65,"cap":"Alignement du bac à tiges : fourreaux à fourches et pattes de retenue du châssis"}]},"7-0":{"blocks":[{"t":"p","text":"Le guide de dépannage (section 12) présente chaque symptôme sous la forme Défaillance / Cause possible / Vérification-Solution. Commencer par les vérifications simples (mode de commande, arrêts d'urgence, batterie de la télécommande) avant l'hydraulique ou les codeurs."},{"t":"specs","rows":[["Ne s'allume pas (mode À DISTANCE, télécommande ÉTEINTE)","Régler COMMANDE DE L'OPÉRATEUR sur LOCAL, activer la télécommande, appuyer sur RÉINITIALISATION DE SÉCURITÉ"],["Ne s'allume pas (arrêt d'urgence enfoncé)","Réinitialiser le(s) bouton(s) d'arrêt d'urgence, puis RÉINITIALISATION DE SÉCURITÉ"],["S'arrête en mode À DISTANCE (E-stop télécommande)","Réarmer l'E-stop, mettre le contournement de la télécommande sur MARCHE, RÉINITIALISATION DE SÉCURITÉ, redémarrer"],["Télécommande radio ne s'allume pas","Remplacer ou recharger la batterie ; vérifier la présence de la clé dans la télécommande"],["Fonctions du mât anormalement lentes","Passer du mode LENT (TURTLE) au mode RAPIDE (RABBIT)"],["Ne fonctionne pas en AUTO ou sur la pointe (TIP)","Vérifier les codeurs et leur câblage sur l'écran de l'IHM"],["Amplitude de rotation de la base trop limitée","Réinitialiser les butées logicielles (section 8.2) ; un écart de 2-3° avec les butées mécaniques est normal"],["Mât erratique ou trajectoire imprévisible","Vérifier codeurs, fixations et points zéro ; recalibrer le mât (section 8.6)"]]},{"t":"ul","items":["Activer la télécommande avant de régler le sélecteur sur À DISTANCE ; l'interrupteur d'inclinaison bloque l'activation si l'unité n'est pas tenue à l'horizontale.","Mât immobile alors que tout semble prêt : vérifier les messages d'erreur, l'alimentation du connecteur de la bobine du clapet anti-retour, l'alimentation en huile / la conduite de détection de charge, le serrage des flexibles sur la foreuse, et que le récepteur radio est sous tension."]},{"t":"warn","w":"note","text":"Pour toute assistance dépassant ce manuel, contacter l'équipe MEDATech : service@medatech.ca ou +1 (705) 443-8440, poste 4."}],"figures":[]},"7-1":{"blocks":[{"t":"p","text":"L'entretien régulier est essentiel au fonctionnement sécuritaire, fiable et efficace du RodBot. Section réservée au personnel d'entretien qualifié. Ce manuel n'est pas un guide de remise en état détaillé : contacter les services d'ingénierie de MEDATech pour toute tâche non couverte."},{"t":"warn","w":"danger","text":"Avant tout entretien — y compris le lavage — mettre le RodBot hors tension, débrancher l'alimentation électrique et appliquer la procédure de cadenassage et d'étiquetage (LOTO) sur tous les systèmes électriques."},{"t":"warn","w":"warn","text":"Certains dispositifs emmagasinent de l'énergie hydraulique (ex. vérins à valves d'équilibrage) ; cette énergie peut subsister même hors tension."},{"t":"ul","items":["Seul le personnel qualifié doit effectuer les réparations, le dépannage ou l'entretien.","Respecter les pratiques de sécurité et les exigences locales pour tout travail en hauteur.","Effectuer l'entretien avec l'articulation (épaule) à l'horizontale ou plus bas, pour éviter les travaux en hauteur inutiles."]}],"figures":[]},"7-2":{"blocks":[{"t":"p","text":"Nettoyer le RodBot, mais ne jamais asperger directement les composants électriques (codeurs rotatifs, panneau électrique). Même résistants à l'eau, leurs joints d'étanchéité peuvent être endommagés par un jet direct de nettoyeur haute pression."},{"t":"warn","w":"warn","text":"Le lavage compte comme un entretien : cadenasser et mettre l'équipement hors tension avant de nettoyer."}],"figures":[]},"7-3":{"blocks":[{"t":"p","text":"Les inspections régulières protègent les opérateurs et détectent tôt des pannes coûteuses. Signaler tout problème immédiatement à la direction et/ou au personnel d'entretien."},{"t":"specs","rows":[["Inspecter flexibles, conduites hydrauliques et câbles électriques (dommages/fuites)","Quotidienne"],["Tester le RodBot sans tige (déplacement conforme)","Quotidienne"],["Vérifier que tous les arrêts d'urgence sont fonctionnels","Hebdomadaire"],["Lubrifier les points d'articulation de la tringlerie et les couronnes d'orientation","Hebdomadaire"],["Ajuster les patins d'usure de l'articulation télescopique","Au besoin"],["Vérifier le niveau d'huile du réducteur d'entraînement des chenilles","Toutes les 500 h"],["Vidanger et remplacer l'huile du réducteur d'entraînement des chenilles","Toutes les 2000 h"],["Inspecter les chenilles","Hebdomadaire"],["Inspecter les structures mécaniques (déformation, fissures de soudure)","Hebdomadaire"]]}],"figures":[]},"7-4":{"blocks":[{"t":"specs","rows":[["Huile hydraulique","Classe de viscosité ISO 46"],["Graisse pour articulations mécaniques","EP2"],["Huile pour réducteur d'entraînement final","SAE 80W90"]]},{"t":"ul","items":["4 points de graissage sur la couronne d'orientation de la base","4 points de graissage sur la couronne d'orientation de rotation","2 points de graissage sur le vérin d'inclinaison"]},{"t":"steps","items":["Graisser l'articulation par les graisseurs de la couronne d'orientation.","Déplacer l'articulation d'environ 30 degrés.","Répéter sur toute la plage de mouvement pour lubrifier toute la couronne."]},{"t":"warn","w":"danger","text":"Ne pas déplacer les articulations d'orientation pendant qu'un technicien se trouve dans le rayon d'action de la machine."}],"figures":[{"page":73,"cap":"Points de graissage sur les couronnes d'orientation (graisseurs encerclés en vert)"}]},"7-5":{"blocks":[{"t":"p","text":"La glissière du télescope est guidée par huit patins en plastique (pucks) qui coulissent contre la flèche intérieure lors du déploiement et de la rétraction. Ils s'usent avec le temps et doivent être réglés pour réduire le jeu et le flottement du bras."},{"t":"steps","items":["Mettre le mât à l'horizontale au-dessus du bac.","Déployer la flèche à 3 po de sa position rétractée.","Mettre la machine hors tension.","Desserrer les contre-écrous de toutes les vis de réglage.","Dévisser toutes les vis jusqu'à ce qu'elles soient libres ou que la flèche intérieure touche la flèche extérieure.","Patins 1 et 2 : serrer ou desserrer jusqu'à insérer une plaque d'acier de calibre 11 (~1/8 po) entre la bande d'usure de la flèche intérieure et l'enveloppe de la flèche extérieure.","Vis 3 et 4 : ne pas serrer ; les laisser accotées, non desserrées.","Répéter le réglage à la plaque de calibre 11 pour les patins 7 et 8.","Répéter l'ajustement accoté (sans serrage) pour les patins 5 et 6.","Serrer les contre-écrous."]},{"t":"ul","items":["En cas de coincement ou de bruits forts : desserrer les patins 3, 4, 5 et 6 jusqu'au résultat souhaité.","Appliquer de la graisse sur les rails de la flèche intérieure.","Vérifier l'absence de frottement sur les butées d'extrémité de flèche ou sur le cordon de soudure de la flèche extérieure."]},{"t":"p","text":"Remplacement : si la tête du boulon bute contre le contre-écrou, remplacer le patin — desserrer le contre-écrou, retirer les 3 boulons de 3/8 po de la plaque de fermeture (article 1), retirer la plaque de poussée métallique (article 2) et le patin (article 3), réassembler dans l'ordre inverse, régler les vis selon la procédure ci-dessus et resserrer le contre-écrou."}],"figures":[{"page":74,"cap":"Patins d'usure du télescope et emplacement des vis de réglage"},{"page":75,"cap":"Ensemble plaque de fermeture (art. 1), plaque de poussée (art. 2) et patin (art. 3)"}]},"7-6":{"blocks":[{"t":"p","text":"Tension : le mou de la chenille doit mesurer entre 20 et 25 mm, vérifié à la règle droite et au ruban à mesurer. Ne jamais laisser le mou dépasser 30 mm et éviter toute tension excessive."},{"t":"steps","items":["Accéder à la valve de réglage de la chenille, derrière la plaque signalétique.","Pour tendre : injecter de la graisse dans le vérin au pistolet à graisse.","Pour détendre : dévisser lentement la valve pour libérer de la graisse."]},{"t":"specs","rows":[["Neuf","22 mm"],["25 % d'usure","18,5 mm"],["50 % d'usure","15 mm"],["75 % d'usure","11,5 mm"],["Limite d'usure (100 %)","8 mm"]]},{"t":"warn","w":"warn","text":"L'usure des patins de chenille est mesurée par la dimension « X » : remplacer la chenille dès que X est inférieure à 8 mm."}],"figures":[{"page":75,"cap":"Vérification du mou de la chenille (20 à 25 mm) à la règle droite et au ruban"},{"page":76,"cap":"Mesure de l'usure du patin (dimension X) et embout de réglage de tension derrière la plaque signalétique"}]},"7-7":{"blocks":[{"t":"ul","items":["Déplacement autonome (tramming)","Remorquage au sol","Chariot élévateur ou chariot télescopique","Remorquage sur une remorque surbaissée","Avant tout déplacement, mettre le bras dans la posture prescrite : la pente maximale est calculée pour cette posture ; tout écart déplace le centre de gravité et réduit la stabilité."]},{"t":"specs","rows":[["Points d'ancrage du châssis","4 points (arrimage, remorquage, levage)"],["Points de levage du bac à tiges","4 points de 9/16 po de diamètre"],["Levage par fourches","Passages de fourches sur le côté du châssis et sur le bac à tiges"]]},{"t":"steps","items":["Désactiver le frein SAHR (serrage par ressort, desserrage hydraulique) : retirer le bouchon des deux ensembles de chenilles à l'aide d'une clé hexagonale M16 ; la machine passe au point mort.","Fixer solidement la machine au véhicule de remorquage avant de désengager les moyeux d'entraînement.","Après le remorquage, réinstaller les bouchons avant toute utilisation."]},{"t":"warn","w":"danger","text":"Toujours fixer solidement la machine avant de désengager les moyeux, sinon risque de mouvement incontrôlé et de blessures graves. Remplacer le moyeu après remorquage pour rétablir le freinage — utiliser la machine sans freins met en danger tout le personnel et les équipements de la zone."}],"figures":[{"page":77,"cap":"Posture du bras à adopter avant tout déplacement de la machine"},{"page":78,"cap":"Bouchon de désactivation du frein SAHR à retirer à la clé hexagonale M16"}]},"7-8":{"blocks":[{"t":"specs","rows":[["Annexe A — Connexion administrateur","Identifiant : opt / Mot de passe : qwer"],["Annexe B — Réinitialisation de la PPU","Bouton d'alimentation PPU maintenu 5 s, puis attente 60 s"],["Annexe C — Appairage AUTEC","Jumelage télécommande/récepteur de rechange (jumelés d'usine)"],["Annexe D — Mise à jour PPU","Fichier taiga.7z sur clé USB vierge"],["Annexe E — Enregistreur de données","Wi-Fi MEDATech-Datalogger / tableau de bord logger.local"]]},{"t":"steps","items":["Réinitialisation de la PPU (Annexe B) — Maintenir le bouton d'alimentation de la PPU enfoncé cinq (5) secondes.","Vérifier que le port USB est alimenté et/ou attendre 60 secondes pour voir si l'erreur PPU disparaît.","Si cela ne fonctionne pas, contacter MEDATech pour obtenir de l'aide."]},{"t":"steps","items":["Mise à jour logicielle PPU (Annexe D) — Copier le fichier taiga.7z dans le répertoire racine d'une clé USB vierge.","Système en marche, brancher la clé au câble USB de la PPU et installer la mise à jour.","Attendre au moins 10 minutes, puis éteindre l'appareil ; retirer la clé USB et rallumer.","Sur l'écran d'accueil de l'IHM, vérifier que la version de la PPU est bien mise à jour."]},{"t":"ul","items":["Enregistreur de données PPU (Annexe E) : machine sous tension, un réseau Wi-Fi « MEDATech-Datalogger » apparaît.","SSID : MEDATech-Datalogger — Mot de passe : Medatech123 ; tableau de bord accessible via l'invite ou à l'adresse logger.local.","Sous-page « Logs » : journaux UDP (PPU) et CAN téléchargeables par intervalles de 5 minutes."]}],"figures":[{"page":81,"cap":"Bouton d'alimentation de la PPU à maintenir enfoncé 5 s pour la réinitialisation"},{"page":86,"cap":"Écran d'accueil de l'IHM affichant la version logicielle de la PPU"}]}}/*__END_ENRICH__*/;
...
var ENRICH_EN = {"0-0":{"blocks":[{"t":"p","text":"The Borterra RodBot LP is a hydraulic robotic drill-rod handling system for smooth loading and unloading of rods. It removes manual rod handling — a leading cause of drill-related injuries — and adapts to many types of equipment: drills, rod baskets and pallets."},{"t":"ul","items":["Track-mounted rod carrier; the tracks reposition the RodBot inside the drift.","Removable rod basket, for rods 5 in in diameter and up to 6 ft long.","Hydraulic and electric supply via a cable connected to a drill.","Main control by Radio Remote Control (RRC): moves rods without manual handling during drilling and tripping."]},{"t":"warn","w":"note","text":"The link cable to the drill also connects the e-Stop buttons of the RodBot and the drill: the two emergency-stop circuits are interconnected."}],"figures":[]},"0-1":{"blocks":[{"t":"ul","items":["Direct control (also \"manual control by radio remote\"): the joysticks drive each slew joint movement individually, like conventional heavy machinery.","Linear control: moves the rod / casing in X, Y or Z with a single joystick movement; the system operates several hydraulic valves at once. The operator keeps individual control of the end-effector's slew actuators (wrist, rotation, gripper tilt).","Trajectory control: the mast moves automatically from a starting pose to a user-defined final pose, on a path computed by the RodBot to minimize travel time while avoiding collisions."]},{"t":"p","text":"In trajectory mode, the operator first defines and saves destination points and waypoints, moving the mast by direct or linear control; rods then move between two locations with a single joystick movement. Details in sections 11.6.3 (linear) and 11.6.4 (trajectory)."}],"figures":[]},"0-2":{"blocks":[{"t":"p","text":"The illustration on page 7 identifies the machine's main components."},{"t":"ul","items":["Gripper","Rod basket","Tracks","Stabilizer cylinders","Remote control unit","Beacon light","24 V electrical panel","Pedestal","Mast","Storage compartment"]}],"figures":[{"page":7,"cap":"Overview: main components of the RodBot LP (gripper, mast, pedestal, rod basket, tracks, stabilizer cylinders, 24 V electrical panel, beacon, remote control unit)."}]},"0-3":{"blocks":[{"t":"specs","rows":[["Empty weight","5,800 lb"],["Weight with empty basket","6,500 lb"],["Length","116 in"],["Width","60 in"],["Minimum height","90 in"]]},{"t":"specs","rows":[["Max. load, general-purpose lifting","308 lb"],["Max. load, rod lifting by electromagnet","120 lb"],["Rod diameter","5 in"],["Rod length","6 ft"],["Basket capacity","35 rods"],["Max. vertical reach (vertical rod, from ground)","159 in"],["Max. horizontal reach (from centerline)","119 in"]]}],"figures":[]},"0-4":{"blocks":[{"t":"specs","rows":[["Electrical supply","120 V AC"],["Maximum current draw","4.5 A"],["Hydraulic supply","From the pump (not included) via the link assembly (included)"],["Required pump type","Variable displacement with load sensing"],["Supply pressure range","2,500-3,000 psi"],["Maximum required flow","80 L/min"],["Hydraulic connections","Pressure (P), Tank (T), Case drain (T/Dr), Load sense (LS)"],["Link assembly length","30 ft"]]},{"t":"specs","rows":[["Ground clearance","10 in"],["Transmission","Open-circuit hydrostatic"],["Brakes","Spring-applied, hydrostatic"],["Max. travel grade, empty basket","35° / 70 %"],["Max. travel grade, full basket","28° / 53 %"],["Max. grade, rod handling","15° / 27 %"],["Track length","71 in"],["Track gauge","46 in"],["Track width","12 in"],["Max. slow travel speed","2.8 km/h"],["Stabilizer stroke","10.5 in"]]}],"figures":[]},"1-0":{"blocks":[{"t":"p","text":"This safety chapter covers the addition of the radio remote and the rollout of trajectory planning on the mast's drill-rod handler."},{"t":"ul","items":["The operator must have read and understood the operating manual and must follow the recommended maintenance schedules.","The Rod Handler must only be operated, serviced and repaired by personnel trained on it and aware of its hazards.","Personnel must follow general and local safety and health regulations."]},{"t":"warn","w":"note","text":"The manufacturer accepts no liability for damage from improper use or arbitrary modifications to the equipment."}],"figures":[]},"1-1":{"blocks":[{"t":"specs","rows":[["DANGER","Life-threatening situation — must be avoided at all costs."],["WARNING","Information of critical importance for safety."],["CAUTION","Information intended to prevent any risk of injury and/or property damage."]]},{"t":"warn","w":"note","text":"The manual's procedures do not relieve the operator from staying cautious, nor from following regional regulations and the safety rules specific to the site and company."}],"figures":[{"page":10,"cap":"Manual safety pictograms: DANGER, WARNING and CAUTION."}]},"1-2":{"blocks":[{"t":"ul","items":["Only operate the robotic system after full training and valid certification.","Always read and understand all labels before use.","Only operate the equipment when in good physical and mental condition, never under the influence of alcohol or drugs.","Never remove guards and safety covers while the system is powered and running.","Clean up oil spills and leaks before startup; resolve all malfunctions before returning to service.","Only use spare parts identical or equivalent to the original parts."]},{"t":"warn","w":"danger","text":"Pressurized fluids: a high-pressure hydraulic oil leak onto the skin can cause a subcutaneous injection injury. If injured, immediately contact emergency medical services or a doctor familiar with this injury — risk of gangrene or severe allergic reactions."},{"t":"warn","w":"warn","text":"Outdoors, do not operate the system during a thunderstorm or in high winds above 65 km/h. Also do not operate it if the control system reports an error or if its proper operation is compromised."},{"t":"warn","w":"note","text":"Do not undertake any maintenance or repair without authorization, proper qualification, and having read and understood the manufacturer's safety instructions; check local and mine-specific regulations."}],"figures":[{"page":11,"cap":"First-steps icons — mindful safe practice."}]},"1-3":{"blocks":[{"t":"p","text":"The machine has four emergency-stop locations; activating one immediately stops all movement of the drill unit."},{"t":"specs","rows":[["Low-voltage control panel","Immediately below the touchscreen HMI"],["Radio remote","Center, bottom"],["RodBot frame","Lower front-right corner of the frame"],["Manual controls","At the rear, near the mast's hydraulic control levers"]]},{"t":"warn","w":"warn","text":"If the emergency-stop signal is coupled to the parent drill, activating an emergency stop on either machine triggers one on both."}],"figures":[]},"2-0":{"blocks":[{"t":"p","text":"The telescopic mast (robotic arm) has several slew joint (wrist) actuators. Each joint has a number (J…) and a name, shown on the diagram on page 13."},{"t":"ul","items":["TELESCOPE","SLEW","ARTICULATION (SHOULDER)","SLEW JOINT (WRIST)","ROTATION","TILT","GRIPPER (JAWS)"]},{"t":"warn","w":"note","text":"Example: the SLEW function = J1 (\"slew 1\")."}],"figures":[{"page":13,"cap":"Diagram of the mast segments and function names"}]},"2-1":{"blocks":[{"t":"p","text":"The operator control switch, on the low-voltage control panel, determines whether the robotic system accepts commands from the radio remote."},{"t":"specs","rows":[["OPERATOR CONTROL REMOTE position","The radio remote is linked to the robotic system and can drive it"],["LOCAL position","Radio remote commands are ignored; the \"No Radio\" icon is displayed"]]},{"t":"ul","items":["Operator control","Safety reset button","Main HMI control panel (Human-Machine Interface)","PPU (Path Planning Unit)","Radio receiver","Emergency stop"]},{"t":"warn","w":"warn","text":"To drive by radio remote, the switch MUST be in REMOTE. In LOCAL, no radio command is executed."}],"figures":[{"page":14,"cap":"Inside view of the main control panel"}]},"2-2":{"blocks":[{"t":"p","text":"The safety reset button activates (\"sets\") the robotic system's safety circuit."},{"t":"steps","items":["At startup: press to establish (set) the safety circuit.","After an emergency stop is triggered then reset: press again to reactivate the circuit."]}],"figures":[]},"2-3":{"blocks":[{"t":"p","text":"The main panel touchscreen (HMI, Human-Machine Interface) shows the RodBot control-system information. The operator can change certain settings there."},{"t":"ul","items":["Indicator: operator control switch set to \"LOCAL\"","\"No Radio\" (radio transceiver not enabled) icon"]},{"t":"warn","w":"note","text":"See manual section 7 for more on this screen."}],"figures":[{"page":15,"cap":"Main panel screen: LOCAL mode indicator and No Radio icon"}]},"2-4":{"blocks":[{"t":"p","text":"Two normally-closed hydraulic enable/isolation valves are built into the link-hose connection manifold. Their state is set by the operator's \"MODE\" choice, or by the safety system if it detects an error."},{"t":"specs","rows":[["Number / type","2 valves, normally closed"],["Location","Link-hose connection manifold"],["One valve","Regulates flow to the tracks and cylinders"],["The other valve","Regulates flow to all other elements"],["State control","Operator's MODE choice or safety system (if an error is detected)"]]},{"t":"warn","w":"warn","text":"In the event of a power loss, both valves close by default, making any hydraulic operation impossible."},{"t":"warn","w":"note","text":"Force manually to the open position: turn the valve counterclockwise."}],"figures":[{"page":16,"cap":"Mast hydraulic enable/isolation valve (normally closed; closes on loss of electrical power)"}]},"3-0":{"blocks":[{"t":"p","text":"The radio remote (RRC), designed for the RodBot, withstands shock, dirt, moisture and water. Its joysticks are fully proportional and spring-return to zero."},{"t":"specs","rows":[["Key location","Upper-left part of the remote"],["Role","The key must be present for the remote to work"],["Without the key","The remote does not power on"],["Removal during operation","Breaks the RRC ↔ receiver link and triggers a stop"]]},{"t":"warn","w":"warn","text":"Never remove the physical key while the machine is running: the RRC ↔ receiver link is broken and a stop is triggered."}],"figures":[{"page":17,"cap":"Overview of the radio remote (RRC)"}]},"3-1":{"blocks":[{"t":"steps","items":["Set the OPERATOR CONTROL switch (electrical panel) to REMOTE; otherwise no movement message is recognized.","Press the ON button on the left side of the remote.","Confirm the LED indicator, at the bottom left of the screen, turns green (\"ON\" state)."]},{"t":"p","text":"To turn off the remote: press its emergency-stop button. Then reset it by turning the red mushroom head."},{"t":"warn","w":"warn","text":"Pressing the remote's emergency stop stops the drill, unless the control mode selector was first set to LOCAL."},{"t":"warn","w":"note","text":"The remote can be turned on with OPERATOR CONTROL on LOCAL, but the system then ignores its RodBot movement messages."}],"figures":[{"page":18,"cap":"ON button and emergency-stop button of the remote"}]},"3-2":{"blocks":[{"t":"p","text":"The wireless radio remote's emergency stop controls a relay on the RodBot, wired in series with the other emergency stops of the RodBot and the parent drill (electrically connected)."},{"t":"p","text":"With the remote active and OPERATOR CONTROL on REMOTE: pressing the emergency stop stops both the RodBot and the parent drill, the same as any wired emergency stop on the RodBot or the drill."},{"t":"warn","w":"danger","text":"In LOCAL mode, radio communication is disabled and the remote's emergency-stop button does NOT work. Never rely on the RRC emergency stop when the selector is on LOCAL."},{"t":"warn","w":"note","text":"Turn off the remote without shutting down the engine: set OPERATOR CONTROL to LOCAL, then turn off via its emergency-stop button. Useful for replacing a weak battery or saving battery power."}],"figures":[]},"3-3":{"blocks":[{"t":"p","text":"The Fast (Rabbit) / Slow (Turtle) modes apply a scaling factor to all joints in DIRECT, LINEAR and TRAJECTORY modes."},{"t":"specs","rows":[["Fast (Rabbit) mode","Maximum speed set in the Valve Setpoints menu (section 8.5)"],["Slow (Turtle) mode","Each joint's speed limited to 50 % (cut in half)"],["Exception","The gripper (jaws) is not slowed by Slow mode"]]}],"figures":[{"page":19,"cap":"Fast (Rabbit)/Slow (Turtle) selector and directional hydraulic valve limit control"}]},"3-4":{"blocks":[{"t":"p","text":"The remote has a tilt switch that detects an operator emergency (remote tilted or dropped)."},{"t":"ul","items":["Triggering: the RodBot enters a safety-stop state, hydraulic power is cut.","Difference from the red button: the wired drill emergency stop is NOT triggered.","Recovery: remote returned to a stable horizontal position and no joystick operated → system automatically exits the safety stop and enters standby."]},{"t":"warn","w":"note","text":"Daily inspection: check the radio remote's tilt switch at the start of each shift."}],"figures":[]},"3-5":{"blocks":[{"t":"p","text":"An amber beacon on top of the RodBot indicates the status of radio remote operation."},{"t":"specs","rows":[["Steady on","RodBot in OPERATOR CONTROL – REMOTE mode"],["Off","RodBot in OPERATOR CONTROL – LOCAL mode"],["Flashing","Mast in TRAJECTORY mode, or machine moving in CRAWL mode"]]}],"figures":[]},"3-6":{"blocks":[{"t":"p","text":"Section 6.7 describes the joystick controls for each LP RodBot operating mode. The remote has three proportional joysticks: JS1, JS2 and JS3."},{"t":"ul","items":["JS1: magnet control (one function is free, unassigned)","Horn and beacon control","Gripper (jaws) activation","Fast (Rabbit) / Slow (Turtle) selector","Status beacon; status and low-battery indicators","Mode selection buttons: Standby (wait), Direct and Linear","Mode selection buttons: ON, stabilizers and slew","Trajectory activation; Help, Wait, Start","Screen brightness adjustment; work lights","Emergency stop"]},{"t":"warn","w":"note","text":"In Slow mode, actuator speed is cut in half (50 %), except for the gripper (jaws)."}],"figures":[{"page":21,"cap":"Layout of the JS1/JS2/JS3 joysticks, buttons and switches on the remote"},{"page":22,"cap":"Detail of the radio remote controls"}]},"3-7":{"blocks":[{"t":"p","text":"The remote's HMI is NOT a touchscreen: the keypad keys above the screen correspond to the icons displayed. The display changes with the RodBot's state to provide the relevant information and control options."},{"t":"ul","items":["Drill position and trajectory points (from rack to drill)","System STATUS indicator","Battery charge state indicator","Rack Positions","Operating mode type and mode indicator","Gripper state and magnet state","Slow / Fast mode","The yellow box indicates the selected item"]}],"figures":[{"page":23,"cap":"Remote screen (HMI): key / icon mapping"},{"page":24,"cap":"Typical screen with status indicator labels"}]},"3-8":{"blocks":[{"t":"p","text":"The battery charge level is shown at the top right of the remote's screen and at the bottom of the electrical panel screen."},{"t":"warn","w":"warn","text":"If the remote loses radio contact or shuts off during operation (dead battery), the machine treats this as an emergency stop. Follow the procedure below to change the battery without triggering the stop."},{"t":"steps","items":["Set the OPERATOR CONTROL selector to LOCAL.","Turn the remote OFF, by pressing the emergency stop on the remote or on the RRC.","Replace the battery.","Turn the remote ON.","Confirm the radio link icon, at the bottom of the control monitor, is restored.","Return the OPERATOR CONTROL selector to REMOTE."]},{"t":"p","text":"Charging and storage: the storage box on the machine contains a battery charger. Insert the battery into the charger; charging starts automatically."}],"figures":[{"page":44,"cap":"Radio remote charger and storage box"}]},"4-0":{"blocks":[{"t":"p","text":"Navigate via the left sidebar icons: press to open a page, press again to return to the main menu. The top bar shows: radio connection status, signal strength, active mode, controller status, PLC and PPU (Path Planning Unit) software versions."},{"t":"specs","rows":[["Radio connection – green","Remote on and connected"],["Radio connection – red","Remote not operational or not authorized"],["Controller indicator – green","Systems operational"],["Controller indicator – red","System powered off or in FAULT"],["Controller indicator – yellow","Loading in progress or warning (non-fault)"]]},{"t":"ul","items":["Press a highlighted status circle to see subsystem details.","\"System settings\" button: opens two screens (arrows at top right) — Joystick curve factor (section 8.4) and Limit valve setpoint (section 8.5)."]},{"t":"warn","w":"note","text":"Encoder calibration, joint tuning (PPU calibration) and the valve bypass screen: changeable only after administrator login. HMI credentials — user: opt / password: qwer."}],"figures":[{"page":25,"cap":"HMI home screen: top status bar and navigation buttons"}]},"4-1":{"blocks":[{"t":"p","text":"The \"ALARMS\" button opens a table to diagnose RodBot anomalies and spot safety risks. Faults have various causes: CAN network faults at startup, joints operated manually in remote mode, etc."},{"t":"ul","items":["System information","System warnings","System faults"]},{"t":"steps","items":["Check the STATUS column: a resolved fault shows Inactive.","Press the row of the fault to clear.","Press \"Clear fault\".","Navigate between pages using the arrows at top right."]},{"t":"warn","w":"warn","text":"Clear ALL faults, active AND inactive, before operation can resume."}],"figures":[{"page":27,"cap":"Example of the ALARMS screen with the STATUS column"}]},"4-2":{"blocks":[{"t":"p","text":"The TRAJECTORY view is a real-time 3D model of the mast and obstacles, per the path-planning software. Access it via the button in the HMI's lower-left corner; press one of the four views to enlarge it, press again to go back."},{"t":"ul","items":["Diagnose problems after a collision","Confirm encoder readings","Diagnose setpoint problems"]},{"t":"p","text":"Objects perceived and avoided during planning: upper limit, lower limit, drill mast, RodBot and its rod basket."},{"t":"warn","w":"warn","text":"The software cannot model every object in an underground mine. If an object to avoid does not appear on screen, add extra setpoints to route around it."}],"figures":[{"page":28,"cap":"TRAJECTORY view: four-view 3D model of the mast position"},{"page":29,"cap":"Objects perceived and avoided: upper/lower limits, mast and rod basket"}]},"4-3":{"blocks":[{"t":"p","text":"Encoder calibration is required if an encoder is replaced, or if it has loosened and slipped on the shaft. Bring the joint to its home position then reset the \"zero point\"; without this reset, the encoder does not report the joint's exact orientation."},{"t":"steps","items":["Power on the machine and set the remote to DIRECT mode.","Log in to the HMI with the administrator credentials (opt / qwer).","One joint at a time: move it to its indicated zero position, then press the corresponding HMI button.","Confirm the value changes as it moves, goes to zero after pressing, and each time it returns to that stop."]},{"t":"specs","rows":[["J1 – Slew","Counterclockwise mechanical stop"],["J2 – Articulation (shoulder)","Maximum up position"],["J3 – Telescope","Fully retracted"],["J4 – Slew joint (wrist)","Maximum down position"],["J5 – Rotation","Counterclockwise to the mechanical stop"],["J6 – Tilt","Tilt cylinder fully extended to the mechanical stop"]]},{"t":"warn","w":"note","text":"Encoders are very precise: slight variations are acceptable (the value may show 1° or 359° instead of 0°)."}],"figures":[{"page":31,"cap":"Zero-point positions of joints J1 to J6"}]},"4-4":{"blocks":[{"t":"specs","rows":[["Mechanical stops","+/- 165° (total travel 330°)"],["Dead zone","30° directly in front of the robotic system"],["Default software limits","10° and 320° (correspond to the mechanical stops)"]]},{"t":"p","text":"The software limits shown on the calibration screen can further restrict slew rotation. To change them, press the number on the screen and enter the desired value."},{"t":"warn","w":"note","text":"The OVERRIDE JOINT LIMITS button allows full travel up to the stops; it resets as soon as the operator leaves the calibration screen."}],"figures":[{"page":32,"cap":"Slew rotation limits and front dead zone"}]},"4-5":{"blocks":[{"t":"p","text":"The valve bypass screen appears on a valve fault in either of the two valve blocks. For experienced operators only. To toggle a bypass, press the \"Fault bypass\" box next to the faulted joint."},{"t":"ul","items":["A known, non-critical fault has occurred (e.g. an overheat) and the operator absolutely must keep running the machine.","A valve fault is present on the Crawl mode and Stabilizers block and the operator wants to keep using Arm mode — or the reverse."]},{"t":"warn","w":"danger","text":"An activated bypass button makes the system ignore ALL faults on that valve. Dangerous if the fault is critical or was preventing an imminent hazard to personnel or the machine."}],"figures":[{"page":33,"cap":"Valve fault bypass screen"}]},"4-6":{"blocks":[{"t":"p","text":"The joystick curves set hydraulic actuator sensitivity relative to the joystick commands: either more joystick travel for fine control, or a linear increase in joint speed. To change the curve, select the sensitivity on the HMI; the icon lights up to confirm."},{"t":"p","text":"If the joints move too fast in DIRECT mode, the VALVE SETPOINT LIMITS screen caps each joint's maximum speed: with the joystick pushed fully, valve flow is lower, so actuator speed is reduced. Press the joint's value, enter the new percentage, confirm with Enter."},{"t":"specs","rows":[["Available control curves","0 to 3"],["Valve setpoint – maximum","100 % (cannot be exceeded)"],["Valve setpoint – recommended minimum","10 %"]]},{"t":"warn","w":"note","text":"The restriction applies to both directions of the joint, but actual speed may vary with gravity. For speeds > 100 % or < 10 %, consult MEDATech for a different valve spool. A button restores the factory defaults."}],"figures":[{"page":34,"cap":"Available joystick control curves (0 to 3)"},{"page":35,"cap":"Per-joint valve setpoint limits screen"}]},"4-7":{"blocks":[{"t":"p","text":"Joint tuning is needed if mast motion becomes jerky or hard to control in LINEAR and Trajectory modes, once encoder calibration is done. Two types: Threshold (the lowest valve setpoint needed to start motion) and Dynamic (delays and speeds matching a range of valve setpoints)."},{"t":"steps","items":["Bring each joint to within 2° or 5 mm of its target, in DIRECT mode.","Press the yellow HMI button: it turns green and the calibration screen appears on the radio remote (RRC).","On the RRC, use the selector to choose the joint under the wanted type (Threshold or Dynamic).","Hold the left joystick to the left: the screen shows \"CALIBRATING\" and the joint runs two back-and-forth cycles (releasing before the end cancels).","Once done, the yellow dot turns green; repeat for each required joint.","Insert the red MEDATech USB key into the PPU's blue cable, wait 1 minute, then remove it.","Send the \"medatech_calibration\" file to MEDATech, which returns a \"cal.7z\" file.","Place \"cal.7z\" on the red USB key, reinsert it for 1 minute, then press the green HMI button to restart the PPU."]},{"t":"specs","rows":[["Slew","25° clockwise first"],["Articulation (shoulder)","50° down first"],["Telescoping","140 mm outward first"],["Slew joint (wrist)","30° up first"],["Rotation","20° clockwise (joystick) first"],["Tilt","40° to the right first"]]},{"t":"warn","w":"warn","text":"During calibration, the joints move without direct operator command and without sensing their surroundings. Stay alert to avoid any collision with the RodBot or an obstacle. Releasing the joystick stops the mast at any time; provide enough clearance, otherwise move the machine or contact MEDATech."}],"figures":[{"page":36,"cap":"Tuning pose: current position brought to the mast target position"},{"page":39,"cap":"RRC calibration screen: current selection and status indicator"}]},"4-8":{"blocks":[{"t":"p","text":"The diagnostics show the status of various control-system elements (component or network communications). The Diagnostics button on the HOME screen opens the first of three screens; these screens are informational and non-interactive, except the navigation arrows at top right."},{"t":"ul","items":["Encoder Diagnostics","Valve Diagnostics","Electrical System Diagnostics"]},{"t":"warn","w":"note","text":"Interlock: the valves lose communication outside their designated mode (CRAWL or MAST). CRAWL mode valves appear faulted in MAST mode, and vice versa — this is normal. Only be concerned if a valve is faulted while in its designated mode (e.g. SLEW valve faulted in MAST mode)."}],"figures":[{"page":41,"cap":"First diagnostic screen accessible from HOME"}]},"5-0":{"blocks":[{"t":"p","text":"The RodBot has no onboard power: it draws electrical and hydraulic power from external sources supplied by the operator, usually mounted on the drill it serves. 10 m link-cable assemblies connect them, letting it position itself freely relative to the drill."},{"t":"specs","rows":[["24 V DC cable (onboard electronics)","P/N 279708"],["Emergency-stop cable (link to the parent drill circuit)","P/N 279729"],["Packaging of the two cables","a single assembly in spiral wrap"],["Connection to the RodBot control panel","connectors 2 and 4"]]},{"t":"ul","items":["The junction box mounts on the parent drill: it contains a 120 V AC → 24 V DC power supply and a connection point for the emergency-stop cable.","To keep the RodBot and parent drill emergency-stop circuits independent, install jumpers between 8-1 and 7-2 per the wiring diagram.","If the parent drill provides sufficient 24 V (section 1.1.3), the 24 V DC power supply can be omitted and the source connected directly to CONN1."]},{"t":"warn","w":"danger","text":"Install the LP RodBot so a barrier separates the operator from the machine and the drill; control is by radio remote from either side of the barrier. If the telescopic mast (robotic arm) moves unexpectedly with no command given, immediately press the emergency stop then diagnose."}],"figures":[{"page":45,"cap":"Junction box mounting and 24 V DC / emergency-stop link cables"},{"page":46,"cap":"Junction box wiring diagram; connection to connectors 2 and 4 of the RodBot panel"}]},"5-1":{"blocks":[{"t":"p","text":"The RodBot's hydraulic functions are driven by an operator-supplied pump, usually an auxiliary pump mounted on the parent drill. Source pump requirements: section 1.1.3."},{"t":"ul","items":["Pressure line","Tank line","Load Sense line","Case drain line"]},{"t":"specs","rows":[["Hydraulic link-hose assembly","P/N 278232, 10 m hoses"],["Quick-connect bulkhead","P/N 278240"],["Bulkhead mounting","2 3/8 in bolts"],["Connection to the RodBot","at the manifold block"]]},{"t":"warn","w":"warn","text":"Replacing the pump may require recalibration. The TRAJECTORY and LINEAR modes rely on set values for latency, ramp speed and maximum hydraulic supply pressure. If either mode (or both) performs poorly after a pump change, contact MEDATech Engineering to schedule a recalibration."}],"figures":[{"page":47,"cap":"Link-hose assembly: pressure, tank, load sense, case drain"},{"page":48,"cap":"Connection bulkhead (2 3/8 in bolts) and RodBot manifold block"}]},"5-2":{"blocks":[{"t":"steps","items":["Connect the RodBot to power via the link cable to the main drill's power box.","Wait for the HMI screen to light up (about 30 seconds).","Make sure the remote's emergency stop is released, then press the green start button to power up.","Follow the on-screen remote instructions to pair it by pressing the green start button again.","Follow the remote and HMI instructions to press the safety reset button on the control panel.","Wait for the startup sequence to finish; the HMI shows the status before switching to STANDBY mode.","In STANDBY mode, the system is ready: select modes from the remote using the side buttons."]},{"t":"warn","w":"note","text":"The HMI screen takes about 30 seconds to light up. The sequence always ends in STANDBY mode, the ready-to-use state."}],"figures":[{"page":49,"cap":"HMI screen and normal RodBot power-up sequence"}]},"5-3":{"blocks":[{"t":"p","text":"The mode is selected from the radio remote, per the diagram in section 6.7. Each mode restricts the accessible functions — a protection: only the active mode's commands are processed."},{"t":"specs","rows":[["STANDBY (or STARTUP)","safety mode: no command possible"],["CRAWL","control of the track drives only"],["STABILIZERS","control of the four cylinders (stabilizers) only"],["DIRECT","control mode for the telescopic mast (robotic arm)"],["LINEAR","second control mode for the telescopic mast"],["TRAJECTORY","autonomous arm movement along predefined setpoints"]]}],"figures":[{"page":50,"cap":"Operating mode selection from the radio remote"}]},"5-4":{"blocks":[{"t":"p","text":"All functions can be operated \"manually\" by moving the hydraulic valve levers when the OPERATOR CONTROL selector is in the LOCAL position."},{"t":"warn","w":"warn","text":"Moving the levers manually while in REMOTE mode: the safety system detects a valve error and enters a protective stop, cutting hydraulic power."},{"t":"steps","items":["Set the machine to LOCAL mode with the switch on the low-voltage control panel.","Press the safety reset button to cancel the protective stop."]},{"t":"ul","items":["Startup is possible if OPERATOR CONTROL is set to LOCAL; or","if OPERATOR CONTROL is on REMOTE and the radio remote is active, emergency stop not pressed in.","\"SAFETY RESET\" restores the safety circuit and radio communication."]}],"figures":[{"page":51,"cap":"\"Tracks and Cylinders\" valve block and manual levers (maintenance only)"}]},"5-5":{"blocks":[{"t":"p","text":"To control the tracks from the remote, set it to CRAWL mode. Switching to CRAWL is impossible when the gripper jaws are closed. The manual levers on the \"Tracks and Cylinders\" block are for track maintenance only (section 13.6): the RodBot ships with these levers disconnected and stored in the rear compartment."},{"t":"ul","items":["Slew: oriented parallel to the machine frame","Hoist: fully lowered","Telescope: retracted","Wrist: pointed down","Gripper: open"]},{"t":"specs","rows":[["Maximum speed — fast (Hi)","2.8 km/h"],["Maximum speed — slow (Lo)","1.5 km/h"],["Manual bypass valve","0.55 in square head, turn 90°"],["Switch to fast speed (Hi)","clockwise rotation"],["Switch to slow speed (Lo)","counterclockwise rotation"]]},{"t":"warn","w":"danger","text":"Never move the RodBot using the manual valves: risk of being struck or crushed by the vehicle. Always move the machine by radio remote. Before any move: visually inspect the path (personnel, obstacles, voids, unstable ground), never stand in front of or beside the machine, use a spotter if visibility is obstructed, and keep the hydraulic and electric link cables out of the path and undercarriage — do not drive over them."}],"figures":[{"page":52,"cap":"Transport pose of the arm to adopt before any move"},{"page":53,"cap":"Hi/Lo manual bypass valve (0.55 in square) of the track circuit"}]},"5-6":{"blocks":[{"t":"p","text":"STANDBY mode lets you pair the radio remote with the receiver, but no command from the remote is processed by the system. It offers a safe mode to start the radio remote before switching to the work modes."},{"t":"warn","w":"note","text":"In STANDBY mode, all safety functions (emergency stop and tilt switch) and the lights remain functional."}],"figures":[{"page":54,"cap":"Mast range of motion: 6-degrees-of-freedom positioning system"}]},"6-0":{"blocks":[{"t":"steps","items":["Close the gripper on the rod: hold the green GRIPPER button and toggle the GRIPPER switch down, at the same time.","Open the gripper and release the rod: hold the green GRIPPER button and the GRIPPER lever up for at least 1 second."]},{"t":"p","text":"The green GRIPPER button is a safety: keep it pressed throughout the operation, otherwise the command is ignored."},{"t":"warn","w":"danger","text":"Never stand under the mast or the gripper. Watch for suspended items in underground mines (electrical cables, water and air lines, ventilation ducts): any contact of the telescopic mast can cause serious injury, death or property damage."}],"figures":[{"page":55,"cap":"Gripper control: green button and toggle operated at the same time"},{"page":56,"cap":"Remote face: green GRIPPER button and gripper toggle"}]},"6-1":{"blocks":[{"t":"p","text":"DIRECT or LINEAR: your choice. LINEAR mode is simplest for most operators. In DIRECT, you control each joint (like a crane, one or several actuators). In LINEAR, you control the gripper and rod position directly."},{"t":"specs","rows":[["DIRECT mode","Joint-by-joint control; WHITE lettering on the face"],["LINEAR mode","Straight-line end-effector control; ORANGE label"],["Left joystick (LINEAR)","Up/Down and Left/Right"],["Right joystick (LINEAR)","In/Out"],["Mast range","6 degrees of freedom; 330° slew between fixed stops (programmable soft stop)"]]},{"t":"ul","items":["FORWARD / BACKWARD — the mast moves the rod toward or away from the base in a straight line, horizontal plane.","UP / DOWN — the mast moves the rod straight up and down, same plane.","LEFT / RIGHT — slews the mast on its base (SLEW), as in manual control."]},{"t":"warn","w":"note","text":"In LINEAR mode, the control system handles all motion. The slew joint (wrist), rotation and tilt stay independently controllable to fine-tune the end-effector positioning."}],"figures":[{"page":57,"cap":"LINEAR control (orange label) and left/right joystick assignment"},{"page":54,"cap":"Mast range of motion at 6 degrees of freedom"}]},"6-2":{"blocks":[{"t":"p","text":"TRAJECTORY mode moves the mast through predefined setpoints while avoiding obstacles (autonomous navigation). Accessible after activating LINEAR or DIRECT mode. Minimum required points: DRILL, WAIT, UPPER LIMIT and LOWER LIMIT."},{"t":"steps","items":["Open the configuration screen: hold the LINEAR (or DIRECT) button for 3 seconds.","Grab a drill rod by its center (± 2\" / 5 cm).","Position the rod in the drill mast or the presenter.","With the trajectory-point selector, highlight DRILL (green = active point).","Push the \"Save/Select\" switch up: a checkmark appears in the box of the on-screen icon."]},{"t":"specs","rows":[["RACK POINT 1","By default above and center of the rod basket; adjustable"],["RACK POINT 2","2nd rack (on ground/off to the side), longer rods; ≥ 1' (30 cm) above the rack, parallel to storage"],["WAIT","Point outside the mast; last segment = direct path to the rod string; often 1 to 2 feet from DRILL"],["DRILL","Rod release and transfer point to the drill; mandatory"],["POINT 1 / POINT 2","Optional waypoints to route around an obstacle"]]},{"t":"p","text":"Example order: RACK POINT → POINT 2 → POINT 1 → WAIT → DRILL. To delete a saved point, highlight it and push the \"Save/Select\" switch down."}],"figures":[{"page":59,"cap":"Trajectory-point selectors and side view of an example automatic mode"},{"page":61,"cap":"Top view: adding a waypoint to route around an obstruction"}]},"6-3":{"blocks":[{"t":"p","text":"The Upper and Lower Limits are two operator-defined horizontal planes that keep the mast and rod out of certain zones. The software uses them to avoid collisions with pipes, the roof / back, a cross member or the floor. Mandatory for TRAJECTORY mode."},{"t":"ul","items":["The RodBot itself","The drill","The rod basket on the RodBot","The Back","The Floor"]},{"t":"steps","items":["Empty the gripper before lowering it (recommended).","Move the gripper to the height below which the rod and the RodBot must not go — the plane is set by the gripper's center of gravity.","Usually at 30 cm from the ground, flick the switch up to set the lower plane.","Follow a similar procedure to set the Upper Limit."]},{"t":"warn","w":"note","text":"Rod detected in the gripper in TRAJECTORY mode: the planner assumes a 1.8 m (6') rod held within 5 cm (2\") of its center and generates a path where no part of the pipe crosses a plane. The DRILL point sets the drill's mast position: redefine it for each new setup."}],"figures":[{"page":62,"cap":"Preset exclusion zones and Upper/Lower Limit planes around the mast"},{"page":63,"cap":"Gripper center of gravity and upper/lower limit plane selectors"}]},"6-4":{"blocks":[{"t":"warn","w":"danger","text":"The RodBot has NO vision system: it detects neither workers, nor vehicles, nor equipment entering its work zone. Limit personnel traffic in the mast's work envelope; set up barriers, boundaries and operating restrictions in accordance with the mine's policies and procedures."},{"t":"warn","w":"warn","text":"Unexpected movement in automatic mode: immediately press one of the emergency-stop buttons (on the remote or the robotic system)."},{"t":"warn","w":"note","text":"Safety: in CRAWL MODE, if the machine moves, all setpoints are deleted EXCEPT RACK POINT 1; reconfigure all others from the new location."},{"t":"warn","w":"note","text":"The TRAJECTORY settings (points and limits) are kept even after power-off and restart. Delete the points as well as the upper and lower limits at the end of each task, before the next setup."}],"figures":[{"page":62,"cap":"Mast work envelope — no presence detection in the zone"}]},"6-5":{"blocks":[{"t":"steps","items":["Confirm that all required trajectory points and the upper and lower limits are set.","With the trajectory-point selector, choose the destination: DRILL or WAIT, and RACK POINT 1 or 2.","Hold the yellow TRAJECTORY button and move the right lever: RIGHT = RACK, LEFT = DRILL.","Once movement starts, release the yellow button: the mast continues the trajectory as long as the lever stays operated.","Releasing the joysticks immediately stops the mast movement."]},{"t":"p","text":"Releasing the yellow button returns the remote to the previous LINEAR or DIRECT mode. You can take back manual control at any time, then reactivate TRAJECTORY (yellow button + right lever): a new collision-free path is generated to the chosen destination. The mode works only while a collision-free path is possible."},{"t":"warn","w":"note","text":"Right lever directions: RIGHT = RACK, LEFT = DRILL."}],"figures":[{"page":64,"cap":"Yellow TRAJECTORY button and right lever to start the autonomous move"},{"page":65,"cap":"Linear mode selected: moving the rod to the DRILL or the RACK"}]},"6-6":{"blocks":[{"t":"p","text":"The frame has alignment features to correctly position the rod basket. The basket is not bolted or clamped: it is held only by the frame's retaining devices."},{"t":"steps","items":["Engage the basket's fork pockets into the frame profiles.","Position the basket laterally between the two frame retaining tabs.","Confirm the basket is properly held before any handling."]},{"t":"warn","w":"note","text":"The basket rests on retainers, not bolted: check its engagement and alignment before loading rods or moving the machine."}],"figures":[{"page":65,"cap":"Rod basket alignment: fork pockets and frame retaining tabs"}]},"7-0":{"blocks":[{"t":"p","text":"The troubleshooting guide (section 12) presents each symptom as Failure / Possible cause / Check-Solution. Start with the simple checks (control mode, emergency stops, remote battery) before the hydraulics or the encoders."},{"t":"specs","rows":[["Does not power on (REMOTE mode, remote OFF)","Set OPERATOR CONTROL to LOCAL, turn on the remote, press SAFETY RESET"],["Does not power on (emergency stop pressed)","Reset the emergency-stop button(s), then SAFETY RESET"],["Stops in REMOTE mode (remote e-Stop)","Reset the e-Stop, set the remote bypass to ON, SAFETY RESET, restart"],["Radio remote does not power on","Replace or recharge the battery; check that the key is present in the remote"],["Mast functions abnormally slow","Switch from SLOW (TURTLE) mode to FAST (RABBIT) mode"],["Does not work in AUTO or on the TIP","Check the encoders and their wiring on the HMI screen"],["Base rotation range too limited","Reset the software stops (section 8.2); a 2-3° gap from the mechanical stops is normal"],["Erratic mast or unpredictable trajectory","Check encoders, fasteners and zero points; recalibrate the mast (section 8.6)"]]},{"t":"ul","items":["Turn the remote ON before setting the selector to REMOTE; the tilt switch blocks turn-on if the unit is not held horizontal.","Mast not moving while everything seems ready: check error messages, power to the check-valve coil connector, oil supply / load-sense line, tightening of the hoses on the drill, and that the radio receiver is powered."]},{"t":"warn","w":"note","text":"For any assistance beyond this manual, contact the MEDATech team: service@medatech.ca or +1 (705) 443-8440, ext. 4."}],"figures":[]},"7-1":{"blocks":[{"t":"p","text":"Regular maintenance is essential to the safe, reliable and efficient operation of the RodBot. This section is for qualified maintenance personnel. This manual is not a detailed overhaul guide: contact MEDATech engineering services for any task not covered."},{"t":"warn","w":"danger","text":"Before any maintenance — including washing — power off the RodBot, disconnect the electrical supply and apply the lockout-tagout (LOTO) procedure on all electrical systems."},{"t":"warn","w":"warn","text":"Some devices store hydraulic energy (e.g. cylinders with counterbalance valves); this energy can remain even when powered off."},{"t":"ul","items":["Only qualified personnel should carry out repairs, troubleshooting or maintenance.","Follow safe practices and local requirements for any work at height.","Perform maintenance with the articulation (shoulder) horizontal or lower, to avoid unnecessary work at height."]}],"figures":[]},"7-2":{"blocks":[{"t":"p","text":"Clean the RodBot, but never spray the electrical components directly (rotary encoders, electrical panel). Even though water-resistant, their seals can be damaged by a direct pressure-washer jet."},{"t":"warn","w":"warn","text":"Washing counts as maintenance: lock out and power off the equipment before cleaning."}],"figures":[]},"7-3":{"blocks":[{"t":"p","text":"Regular inspections protect operators and catch costly failures early. Report any problem immediately to management and/or maintenance personnel."},{"t":"specs","rows":[["Inspect hoses, hydraulic lines and electrical cables (damage/leaks)","Daily"],["Test the RodBot without a rod (movement as expected)","Daily"],["Confirm that all emergency stops are functional","Weekly"],["Lubricate the linkage pivot points and the slew rings","Weekly"],["Adjust the telescopic joint wear pads","As needed"],["Check the oil level of the track drive gearbox","Every 500 h"],["Drain and replace the track drive gearbox oil","Every 2,000 h"],["Inspect the tracks","Weekly"],["Inspect the mechanical structures (deformation, weld cracks)","Weekly"]]}],"figures":[]},"7-4":{"blocks":[{"t":"specs","rows":[["Hydraulic oil","ISO 46 viscosity grade"],["Grease for mechanical joints","EP2"],["Final drive gearbox oil","SAE 80W90"]]},{"t":"ul","items":["4 grease points on the base slew ring","4 grease points on the rotation slew ring","2 grease points on the tilt cylinder"]},{"t":"steps","items":["Grease the joint through the slew ring grease fittings.","Move the joint about 30 degrees.","Repeat over the full range of motion to fully lubricate the ring."]},{"t":"warn","w":"danger","text":"Do not move the slew joints while a technician is within the machine's working radius."}],"figures":[{"page":73,"cap":"Grease points on the slew rings (grease fittings circled in green)"}]},"7-5":{"blocks":[{"t":"p","text":"The telescope slide is guided by eight plastic pads (pucks) that slide against the inner boom during extension and retraction. They wear over time and need adjustment to reduce play and float in the arm."},{"t":"steps","items":["Move the mast horizontal above the basket.","Extend the boom to 3 in from its retracted position.","Power off the machine.","Loosen the locknuts of all the adjustment screws.","Unscrew all the screws until they are loose or the inner boom touches the outer boom.","Pads 1 and 2: tighten or loosen until an 11-gauge steel plate (~1/8 in) fits between the inner boom's wear strip and the outer boom's shell.","Screws 3 and 4: do not tighten; leave them seated, not loose.","Repeat the 11-gauge plate adjustment for pads 7 and 8.","Repeat the seated (no-tightening) adjustment for pads 5 and 6.","Tighten the locknuts."]},{"t":"ul","items":["In case of binding or loud noises: loosen pads 3, 4, 5 and 6 until the desired result.","Apply grease to the inner boom rails.","Check for no rubbing on the boom end stops or the outer boom weld bead."]},{"t":"p","text":"Replacement: if the bolt head bottoms out against the locknut, replace the pad — loosen the locknut, remove the 3 3/8 in bolts from the closure plate (item 1), remove the metal thrust plate (item 2) and the pad (item 3), reassemble in reverse order, adjust the screws per the procedure above and retighten the locknut."}],"figures":[{"page":74,"cap":"Telescope wear pads and location of the adjustment screws"},{"page":75,"cap":"Closure plate assembly (item 1), thrust plate (item 2) and pad (item 3)"}]},"7-6":{"blocks":[{"t":"p","text":"Tension: the track sag (slack) must measure between 20 and 25 mm, checked with a straightedge and a tape measure. Never let the sag exceed 30 mm and avoid over-tensioning."},{"t":"steps","items":["Access the track adjustment valve, behind the nameplate.","To tension: inject grease into the cylinder with a grease gun.","To slacken: slowly unscrew the valve to release grease."]},{"t":"specs","rows":[["New","22 mm"],["25 % wear","18.5 mm"],["50 % wear","15 mm"],["75 % wear","11.5 mm"],["Wear limit (100 %)","8 mm"]]},{"t":"warn","w":"warn","text":"Track pad wear is measured by dimension \"X\": replace the track as soon as X is below 8 mm."}],"figures":[{"page":75,"cap":"Checking track sag (20 to 25 mm) with a straightedge and tape"},{"page":76,"cap":"Measuring pad wear (dimension X) and tension adjustment fitting behind the nameplate"}]},"7-7":{"blocks":[{"t":"ul","items":["Autonomous travel (tramming)","Ground towing","Forklift or telehandler","Towing on a lowboy trailer","Before any move, set the arm in the prescribed pose: the maximum grade is calculated for this pose; any deviation shifts the center of gravity and reduces stability."]},{"t":"specs","rows":[["Frame anchor points","4 points (tie-down, towing, lifting)"],["Rod basket lifting points","4 points 9/16 in in diameter"],["Fork lifting","Fork passages on the side of the frame and on the rod basket"]]},{"t":"steps","items":["Disable the SAHR brake (spring-applied, hydraulically released): remove the plug from both track assemblies with an M16 hex wrench; the machine goes to neutral.","Firmly secure the machine to the towing vehicle before disengaging the drive hubs.","After towing, reinstall the plugs before any use."]},{"t":"warn","w":"danger","text":"Always firmly secure the machine before disengaging the hubs, otherwise risk of uncontrolled movement and serious injury. Replace the hub after towing to restore braking — operating the machine without brakes endangers all personnel and equipment in the area."}],"figures":[{"page":77,"cap":"Arm pose to adopt before any move of the machine"},{"page":78,"cap":"SAHR brake disable plug to remove with an M16 hex wrench"}]},"7-8":{"blocks":[{"t":"specs","rows":[["Appendix A — Administrator login","User: opt / Password: qwer"],["Appendix B — PPU reset","Hold the PPU power button 5 s, then wait 60 s"],["Appendix C — AUTEC pairing","Pairing a spare remote/receiver (factory-paired)"],["Appendix D — PPU update","taiga.7z file on a blank USB key"],["Appendix E — Data logger","MEDATech-Datalogger Wi-Fi / logger.local dashboard"]]},{"t":"steps","items":["PPU reset (Appendix B) — Hold the PPU power button for five (5) seconds.","Confirm that the USB port is powered and/or wait 60 seconds to see if the PPU error clears.","If this does not work, contact MEDATech for assistance."]},{"t":"steps","items":["PPU software update (Appendix D) — Copy the taiga.7z file to the root directory of a blank USB key.","With the system running, plug the key into the PPU's USB cable and install the update.","Wait at least 10 minutes, then turn off the device; remove the USB key and power back on.","On the HMI home screen, confirm that the PPU version number is updated."]},{"t":"ul","items":["PPU data logger (Appendix E): with the machine powered, a \"MEDATech-Datalogger\" Wi-Fi network appears.","SSID: MEDATech-Datalogger — Password: Medatech123; dashboard accessible via the prompt or at the address logger.local.","\"Logs\" sub-page: UDP (PPU) and CAN logs downloadable in 5-minute intervals."]}],"figures":[{"page":81,"cap":"PPU power button to hold for 5 s for the reset"},{"page":86,"cap":"HMI home screen showing the PPU software version"}]}};
