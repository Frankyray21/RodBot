...
var QUIZ2_EN = {"0":[{"type":"qcm","text":"You are connecting the RodBot to the drill's pump. What hydraulic supply does the manual require?","options":["1500 to 2000 psi and 80 L/min","2500 to 3000 psi and 80 L/min","2500 to 3000 psi and 120 L/min"],"correct":1,"page":8,"fb":"The RodBot requires a supply pressure of 2500 to 3000 psi and a maximum flow of 80 L/min, delivered by a variable displacement pump with load sensing."},{"type":"vf","text":"Before using TRAJECTORY mode, the operator must define and record the destination and waypoint positions himself.","options":["True","False"],"correct":0,"page":6,"fb":"True. The operator records the points by moving the mast in direct or linear control, then the RodBot computes the path between those points on its own."},{"type":"multi","text":"According to the RodBot LP specifications, check all the correct statements.","options":["The maximum general-purpose lifting load is 308 lb","The rod basket holds 50 rods","The maximum horizontal reach is 119 in from the central axis","The empty weight of the machine is 6500 lb","The machine is 60 in wide"],"correct":[0,2,4],"page":8,"fb":"Correct answers: 308 lb, 119 in and 60 in. The basket holds 35 rods, and the empty weight is 5800 lb, 6500 lb being the weight with the empty basket."},{"type":"cloze","text":"The mast's maximum vertical reach (rod vertical, measured from the ground) is _____ in.","options":["90","119","159"],"correct":2,"page":8,"fb":"The maximum vertical reach is 159 in from the ground. 119 in is the maximum horizontal reach and 90 in is the machine's minimum height."},{"type":"order","text":"Rank these situations from the HIGHEST allowable maximum grade to the LOWEST.","options":["Rod handling","Travel, empty basket","Travel, full basket"],"correct":[1,2,0],"page":8,"fb":"Empty basket: 35 degrees (70%), full basket: 28 degrees (53%), rod handling: 15 degrees (27%). The more delicate the task, the lower the allowable grade."}],"1":[{"type":"qcm","text":"In the field, a fine jet of pressurized hydraulic oil has gone through a coworker's glove. The wound looks tiny and painless. What do you do?","options":["Clean the wound, apply a compression bandage and monitor it during the shift","Bleed the hydraulic circuit, then resume work if no pain sets in","Contact emergency medical services immediately"],"correct":2,"page":11,"fb":"A subcutaneous injection of hydraulic fluid is a medical emergency, even if the wound looks minor. Without prompt treatment by a doctor familiar with this type of injury, there is a risk of gangrene."},{"type":"vf","text":"In the manual, the WARNING pictogram indicates a situation that directly endangers life.","options":["True","False"],"correct":1,"page":10,"fb":"False. The DANGER pictogram is the one that indicates a life-threatening situation. WARNING indicates information of crucial importance for safety."},{"type":"cloze","text":"The emergency stop mounted on the RodBot chassis is located at the lower _____ corner of the chassis.","options":["front left","rear right","front right"],"correct":2,"page":12,"fb":"The chassis emergency stop is at the lower front right corner. The other three are on the low-voltage panel, the radio remote and the rear manual controls."},{"type":"multi","text":"Before commissioning, which of the manual's rules apply? Check all correct answers.","options":["Remove the safety guards to inspect the system while it is energized","Clean up oil spills and leaks","Fix any malfunction found before returning the system to service","Use only spare parts identical or equivalent to the original parts"],"correct":[1,2,3],"page":11,"fb":"You must clean up oil leaks, correct any malfunction and use only identical or equivalent parts. Safety guards and covers are never removed while the system is energized."},{"type":"qcm","text":"A thunderstorm is approaching and the wind is blowing at 55 km/h. The robotic system is operating outdoors. What do you do?","options":["Stop the system: operation during a thunderstorm is prohibited","Keep going: the 65 km/h wind limit has not been reached","Keep going in Slow (Turtle) mode as long as the wind stays below 65 km/h"],"correct":0,"page":11,"fb":"During a thunderstorm, outdoor operation is prohibited regardless of wind speed. The 65 km/h limit is a separate condition that also prohibits operation."}],"2":[{"type":"vf","text":"After an emergency stop button has been reset (unlatched), the robot's safety circuit reactivates by itself.","options":["True","False"],"correct":1,"page":15,"fb":"False. After an emergency stop is reset, you must press the safety reset button again to reactivate the safety circuit."},{"type":"qcm","text":"How is the hydraulic flow split between the two enable/isolation valves?","options":["One regulates the pressure line (P), the other the tank return (T) and the case drain","One regulates the mast and telescope circuit, the other the gripper and electromagnet circuit","One regulates flow to the tracks and cylinders, the other to everything else"],"correct":2,"page":16,"fb":"One valve regulates flow to the tracks and cylinders, the other to all other elements. They are normally closed and located on the linkage hose connection manifold."},{"type":"cloze","text":"The mast's SLEW function corresponds to joint number _____.","options":["J1","J3","J6"],"correct":0,"page":13,"fb":"SLEW is joint J1. Next come the JOINT (shoulder) and the TELESCOPE, with the wrist and gripper completing the chain."},{"type":"qcm","text":"The No Radio icon is displayed on the main panel touchscreen. What is the cause?","options":["The radio remote's battery is completely dead","The operator control switch is set to LOCAL","The main panel's radio receiver is faulty"],"correct":1,"page":15,"fb":"The No Radio icon appears when the operator control switch is set to LOCAL: the remote's motion commands are then ignored."},{"type":"multi","text":"What can change the state of the two hydraulic isolation valves? Check all correct answers.","options":["A loss of electrical power","An error detected by the safety system","Switching the selector from Fast (Rabbit) to Slow (Turtle)","The MODE chosen by the operator"],"correct":[0,1,3],"page":16,"fb":"The valves' state depends on the chosen MODE and the safety system can change it when an error is detected. On any power loss they close by default. The Fast/Slow selector only affects speed."}],"3":[{"type":"qcm","text":"The operator wants to turn off the remote to save its battery, without stopping the drill. What must he do?","options":["Press the remote's emergency stop button directly","Remove the physical key located at the top left of the remote","Set OPERATOR CONTROL to LOCAL, then turn off the RRC"],"correct":2,"page":18,"fb":"First set OPERATOR CONTROL to LOCAL, then deactivate the RRC with its emergency stop button. In REMOTE, that emergency stop would also stop the drill, and removing the key triggers a stop."},{"type":"vf","text":"When the remote's tilt switch trips (remote dropped), the drill's wired emergency stop is also activated.","options":["True","False"],"correct":1,"page":19,"fb":"False. The tilt switch puts the RodBot into a safety stop and cuts the hydraulic supply, but it does not trigger the drill's wired emergency stop."},{"type":"qcm","text":"The amber beacon on top of the RodBot is flashing. What does that mean?","options":["The radio link with the remote has just been lost during operation","The mast is in TRAJECTORY or the machine is moving in CRAWL","The radio remote's battery is almost dead"],"correct":1,"page":20,"fb":"Flashing means the mast is in TRAJECTORY mode or the machine is moving in CRAWL mode. Steady means REMOTE control is active, off means LOCAL mode."},{"type":"order","text":"Put the radio remote start-up steps back in order.","options":["Press the ON button on the left side of the remote","Check that the LED at the bottom left turns green","Set OPERATOR CONTROL to REMOTE"],"correct":[2,0,1],"page":17,"fb":"First set OPERATOR CONTROL to REMOTE, otherwise no motion message is recognized. Then press ON, then check that the LED turns green."},{"type":"cloze","text":"If the remote loses radio contact or shuts down with a dead battery during operation, the machine reacts as to an _____.","options":["emergency stop","switch to LOCAL mode","return to standby"],"correct":0,"page":44,"fb":"A loss of radio link or a dead battery during operation is treated like an emergency stop. Follow the battery replacement procedure to avoid triggering one."}],"4":[{"type":"qcm","text":"After CAN network faults at start-up, the STATUS column of the alarms table shows several faults as Inactive. What must you do before resuming operation?","options":["Restart the machine to clear the fault list","Clear only the faults that are still active","Select and clear every fault, active or inactive"],"correct":2,"page":27,"fb":"A resolved fault turns Inactive but stays in the list. You must select each row and press Clear fault, for all active and inactive faults, before resuming operation."},{"type":"cloze","text":"The default slew software limits are set at 10° and _____°.","options":["330","320","165"],"correct":1,"page":32,"fb":"The default software limits are 10° and 320°, matching the mechanical stops at plus or minus 165° (330° total travel, with a 30° dead zone at the front)."},{"type":"vf","text":"The OVERRIDE JOINT LIMITS button stays active until the operator turns it off manually.","options":["True","False"],"correct":1,"page":32,"fb":"False. This button allows full travel to the mechanical stops, but it resets automatically as soon as the operator leaves the calibration screen."},{"type":"multi","text":"In which cases does the manual allow activating a valve fault bypass? Check all correct answers.","options":["A known non-critical fault, for example overheating, and operation absolutely must continue","A valve fault on the Crawl and Stabilizers block while you want to keep working in Arm mode","A fault that was precisely serving to prevent an imminent danger to personnel or the machine","A confirmed critical fault on a valve in its designated mode"],"correct":[0,1],"page":33,"fb":"The bypass is reserved for an experienced operator, for a known non-critical fault or a fault on the other mode's block. It makes the system ignore ALL faults on that valve: dangerous if the fault is critical or was preventing an imminent danger."},{"type":"qcm","text":"During encoder calibration, to which position must the telescope (J3) be brought to reset its zero point?","options":["Fully retracted","Fully extended","Mid-stroke, mast horizontal"],"correct":0,"page":31,"fb":"The J3 telescope zero is set fully retracted, in DIRECT mode with the administrator login. After pressing the HMI button, the value must return to zero (a reading of 1° or 359° is still acceptable)."}],"5":[{"type":"order","text":"Put the steps of the start-up sequence back in order.","options":["Press the panel's safety reset button","Check that the remote control's emergency stop is released","Press the green start button","Connect the link cable to the drill's power supply box","Wait for the HMI screen to power up (about 30 seconds)"],"correct":[3,4,1,2,0],"page":49,"fb":"Connect the cable, wait about 30 seconds for the HMI, check the remote's emergency stop, press the green button, then the safety reset. The sequence always ends in STANDBY mode."},{"type":"qcm","text":"In STABILIZERS mode, which functions can the remote control operate?","options":["The stabilizer cylinders and the tracks","All functions except the telescopic mast","The four stabilizer cylinders only"],"correct":2,"page":50,"fb":"Each mode restricts the available functions: STABILIZERS controls only the four cylinders and CRAWL controls only the tracks. Only commands from the active mode are processed."},{"type":"vf","text":"In STANDBY mode, the emergency stop and the tilt switch are inactive since no remote control command is processed.","options":["True","False"],"correct":1,"page":54,"fb":"False. In STANDBY, movement commands are not processed, but all safety functions remain active, including the emergency stop, the tilt switch and the lights."},{"type":"qcm","text":"A hydraulic valve lever was operated while the machine was in REMOTE mode. It is now in a protective stop. How do you restore operation?","options":["Release the lever and wait for the system to reset automatically","Set the selector to LOCAL then press the safety reset","Cut then restore the electrical power through the link cable"],"correct":1,"page":51,"fb":"Operating a manual lever in REMOTE mode triggers a valve error and a protective stop. To clear it: switch to LOCAL with the panel switch, then press the safety reset."},{"type":"cloze","text":"In CRAWL mode, the maximum travel speed in low speed (Lo) is _____ km/h.","options":["1.5","2.8","3.5"],"correct":0,"page":52,"fb":"1.5 km/h in low speed and 2.8 km/h in high speed. The Hi/Lo change is made at the manual bypass valve (0.55 in square head) turned 90 degrees."}],"6":[{"type":"qcm","text":"The operator pushes the GRIPPER rocker up for more than one second, but the gripper stays closed. What is the most likely cause?","options":["Opening the gripper is only possible in DIRECT mode","Pushing the rocker up commands closing, not opening","The green GRIPPER button was not held down at the same time"],"correct":2,"page":55,"fb":"The green GRIPPER button is a safety: it must stay pressed during the whole maneuver, otherwise the command is ignored. Open: green button plus rocker up for at least one second. Close: green button plus rocker down."},{"type":"order","text":"Put the execution of a TRAJECTORY move toward the drill back in order.","options":["Release the yellow button once the motion has started","Choose the destination with the point selector","Hold the yellow TRAJECTORY button and operate the right lever","Check that the required points and the upper and lower limits are set"],"correct":[3,1,2,0],"page":64,"fb":"Check points and limits, choose the destination, hold the yellow button while operating the right lever, then release the yellow button once the motion has started. The mast stops as soon as the joysticks are released."},{"type":"vf","text":"The TRAJECTORY setpoints and limits stay in memory even after the machine is fully powered down.","options":["True","False"],"correct":0,"page":63,"fb":"True. TRAJECTORY settings are kept after a power-down and restart. That is why you must delete the points and limits yourself at the end of each task, before the next setup."},{"type":"qcm","text":"In TRAJECTORY mode, in which direction do you push the right lever to send the mast to the DRILL point?","options":["Up","To the right","To the left"],"correct":2,"page":64,"fb":"Right lever to the left: DRILL. To the right: RACK. The motion starts only if a collision-free path is possible."},{"type":"cloze","text":"To open the TRAJECTORY mode configuration screen, hold the LINEAR or DIRECT button for _____ seconds.","options":["2","3","5"],"correct":1,"page":59,"fb":"Hold the LINEAR or DIRECT button for 3 seconds. The rod must then be gripped by its center, within 5 cm (2 in), before recording the DRILL point."}],"7":[{"type":"qcm","text":"Which lubricant is specified for the mechanical joints (slew rings)?","options":["ISO 46 oil","EP2 grease","SAE 80W90 oil"],"correct":1,"page":73,"fb":"EP2 grease for the mechanical joints. ISO 46 is the hydraulic oil grade and SAE 80W90 the final drive gearbox oil."},{"type":"cloze","text":"A new track pad measures 22 mm at the X wear dimension. The track must be replaced as soon as X drops below _____ mm.","options":["15","11.5","8"],"correct":2,"page":75,"fb":"The wear limit is 8 mm. Intermediate marks: 18.5 mm at 25 percent wear, 15 mm at 50 percent and 11.5 mm at 75 percent."},{"type":"vf","text":"Since the rotary encoders are water resistant, you can aim the pressure washer jet directly at them when washing.","options":["True","False"],"correct":1,"page":71,"fb":"False. Never spray electrical components such as the encoders or the panel directly: a direct jet can damage their seals. Washing counts as maintenance and requires power-down and lockout."},{"type":"multi","text":"Which checks are WEEKLY in the inspection schedule? Check all correct answers.","options":["Test all emergency stops","Inspect hydraulic hoses and electrical cables","Lubricate the linkage points and slew rings","Check the track drive gearbox oil level","Inspect the tracks"],"correct":[0,2,4],"page":72,"fb":"Weekly: emergency stops, lubrication of joints and slew rings, inspection of tracks and structures. Hoses and cables are checked daily, and the gearbox oil level every 500 hours."},{"type":"order","text":"Put the steps of ground towing back in order.","options":["Reinstall the SAHR brake plugs","Secure the machine firmly to the towing vehicle","Remove the SAHR plugs from both tracks (M16 wrench)","Tow the machine"],"correct":[1,2,3,0],"page":78,"fb":"Secure the machine first, then remove the SAHR plugs from both tracks, tow, then reinstall the plugs. Without the plugs reinstalled, the machine has no brakes."}]};
