...
var FIELD_GUIDES_FR = [
  [
    {title:"Comprendre le travail du RodBot", items:["Câble de liaison branché et protégé.","Personne dans la zone des tiges.","Arrêt d'urgence accessible avant de commencer."]},
...
var FIELD_GUIDES_EN = [
  [
    {title:"Understand the RodBot's job", items:["Link cable connected and protected.","No one in the rod zone.","Emergency stop reachable before starting."]},
  ...
  blocks: [
    {
      t: "ul",
      items: [
        "Commande : radio-télécommande (**RRC**).",
        "Alimentation : câble vers la foreuse, hydraulique + électrique.",
        "Le câble relie aussi les ##arrêts d'urgence## du RodBot et de la foreuse.",
        "Bac amovible : vérifier les retenues avant de déplacer.",
        "Tiges prévues : **5 po x 6 pi**."
      ]
    }
  ],
  figures: []
  ...
  blocks: [
    {
      t: "ul",
      items: [
        "Control: radio remote control (**RRC**).",
        "Power: link cable to the drill, hydraulic + electric.",
        "The cable also links the RodBot and drill ##emergency stops##.",
        "Removable basket: check the retainers before moving.",
        "Rod size: **5 in x 6 ft**."
      ]
    }
  ],
  figures: []
