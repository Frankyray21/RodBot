...
/* ============ RÈGLES DE CONCEPTION DES QUIZ (à respecter pour TOUTE modification) ============
   ...
   2. Sécurité et opération d'abord : pas de trivia de specs sans enjeu (psi, L/min,
      vitesses moteur, graisses). Les limites de sécurité chiffrées sont permises.
